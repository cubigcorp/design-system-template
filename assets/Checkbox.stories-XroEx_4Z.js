import{j as e}from"./jsx-runtime-CkxAiKt7.js";import{r as V}from"./iframe-DLnsz365.js";import{d as W}from"./styled-components.browser.esm-FqZODMTr.js";import{c}from"./color-CMFzNX_O.js";import{b as h,t as g}from"./borderColor-C1c8KEhD.js";import"./typography-he8MZv4l.js";import{r as q}from"./radius-DaoU83SK.js";import{s as N}from"./spacing-tE1IiUFl.js";import{I as _}from"./IconVisibilityOn-uDDbXZc_.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";const n=({variant:a="secondary",state:r="unchecked",disabled:s=!1,onChange:t,className:m="",...y})=>{const u=()=>{if(s)return;const l=r!=="checked";t==null||t(l)},f=()=>r==="checked"?e.jsx(_,{width:16,height:16,color:"currentColor"}):null;return e.jsx(E,{$variant:a,$state:r,$disabled:s,onClick:u,className:m,...y,children:f()})},E=W.div`
  width: 16px;
  height: 16px;
