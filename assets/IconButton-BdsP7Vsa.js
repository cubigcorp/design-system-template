import{j as p}from"./jsx-runtime-DTznObQx.js";import{l,d as V}from"./styled-components.browser.esm-CbqwAcww.js";import{c as e}from"./color-BKBaEAUu.js";import{r as q}from"./radius-DaoU83SK.js";import{f as g}from"./fontFamily-CsG1KcIF.js";import{s as f}from"./spacing-tE1IiUFl.js";import{b as u}from"./borderColor-C94_pvKu.js";import{t as c}from"./textColor-C1-D1tBN.js";import{b as B}from"./brandColor-B7_BrDA7.js";import{n as G,p as j}from"./negativeColor-CUiOZlpg.js";import{S as E}from"./Spinner-Csj-7xh3.js";import{R as m}from"./iframe-CjirL-zO.js";const F=V.button.withConfig({shouldForwardProp:n=>!["loading","state","radiusKey","type"].includes(n)})`
  display: inline-flex;
  align-items: center;
  ...
  ${({loading:n})=>n&&l`
      ...
      pointer-events: none;
    `}
`,M=({type:n="solid",variant:o="primary",size:r="medium",state:t="default",disabled:s=!1,loading:a=!1,icon:d,onClick:h,className:y,radiusKey:v,lang:w})=>{const[$,i]=m.useState(t);m.useEffect(()=>{i(t)},[t]);const b=()=>{!s&&!a&&t==="default"&&i("hovered")},x=()=>{!s&&!a&&i(t)},C=()=>{!s&&!a&&t==="default"&&i("pressed")},k=()=>{!s&&!a&&t==="default"&&i("hovered")},S=()=>{!s&&!a&&t==="default"&&i("focused")},T=()=>{!s&&!a&&i(t)};return p.jsxs(F,{type:n,variant:o,size:r,state:t!=="default"?t:$,disabled:s,loading:a,radiusKey:v,lang:w,onClick:h,className:y,onMouseEnter:b,onMouseLeave:x,onMouseDown:C,onMouseUp:k,onFocus:S,onBlur:T,children:[p.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",opacity:a?0:1,transition:"opacity 0.2s ease"},children:d&&m.createElement(d)}),p.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",opacity:a?1:0,transition:"opacity 0.2s ease"},children:p.jsx(E,{})})]})};M.__docgenInfo={description:"",methods:[],displayName:"IconButton",props:{type:{required:!1,tsType:{name:"union",raw:'"solid" | "outline"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"outline"'}]},description:"",defaultValue:{value:'"solid"',computed:!1}},variant:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "brand"
| "positive"
