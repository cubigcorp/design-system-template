import{j as d}from"./jsx-runtime-BK5MheKj.js";import{d as i}from"./styled-components.browser.esm-Bhk2HcmV.js";import{c as r}from"./color-8lQV87gD.js";import{b as a}from"./borderColor-CxrOUVvi.js";import{r as l}from"./radius-DaoU83SK.js";const n=({state:e="unchecked",disabled:o=!1,onChange:t,className:s="",style:c,...u})=>{const p=()=>{if(o)return;const m=e!=="checked";t==null||t(m)};return d.jsx(f,{$state:e,$disabled:o,onClick:p,className:s,style:c,...u,children:e==="checked"&&d.jsx(b,{})})},f=i.div`
  width: 16px;
  height: 16px;
