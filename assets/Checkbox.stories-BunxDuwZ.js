import{j as e}from"./jsx-runtime-BftZwRmn.js";import{r as V}from"./iframe-C9p661aJ.js";import{d as W}from"./styled-components.browser.esm-C-Z7IGPz.js";import{c}from"./color-DlZ4f652.js";import{b as h,t as g}from"./borderColor-7dRAAa5F.js";import{r as q}from"./radius-DaoU83SK.js";import{s as N}from"./spacing-tE1IiUFl.js";import{I as _}from"./IconClose-AWD8-o8O.js";const n=({variant:a="secondary",state:r="unchecked",disabled:s=!1,onChange:t,className:y="",...m})=>{const u=()=>{if(s)return;const l=r!=="checked";t==null||t(l)},f=()=>r==="checked"?e.jsx(_,{width:16,height:16,color:"currentColor"}):null;return e.jsx(E,{$variant:a,$state:r,$disabled:s,onClick:u,className:y,...m,children:f()})},E=W.div`
  width: 16px;
  height: 16px;
