import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{R as se}from"./iframe-D0DrdOha.js";import{d as o}from"./styled-components.browser.esm-DPRVC5T4.js";import{c as a}from"./color-CiwAFuFb.js";import{n as v,p as I}from"./negativeColor-DPOOrHeE.js";import{r as le}from"./radius-DaoU83SK.js";import{s as i}from"./spacing-tE1IiUFl.js";import{t as n}from"./textColor-DLZeZODc.js";import{t as Z}from"./typography-CHdGJV44.js";import{S as ce}from"./icon_chevron-right_outline_20-CTHRRbA6.js";import{S as j,a as ue,b as pe,c as de}from"./icon_warning_fill_16-BxwtNOKt.js";import"./preload-helper-eJNa_G2e.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./lineHeight-aJXO3HIm.js";const t=se.forwardRef(({variant:r="primary",size:h="medium",title:ee,description:x,leadingIcon:C=!0,trailingIcon:re=!1,onTrailingIconClick:ae,className:ne,...te},ie)=>{const oe=()=>{if(!C)return null;switch(r){case"positive":return e.jsx(de,{});case"negative":return e.jsx(pe,{});case"cautionary":return e.jsx(ue,{});case"info":return e.jsx(j,{});default:return e.jsx(j,{})}};return e.jsxs(ge,{ref:ie,className:ne,$variant:r,$size:h,...te,children:[C&&e.jsx(me,{$variant:r,$size:h,children:oe()}),e.jsxs(ye,{children:[e.jsx(fe,{$variant:r,children:ee}),x&&e.jsx(ve,{$variant:r,children:x})]}),re&&e.jsx(Ie,{onClick:ae,$variant:r,children:e.jsx(ce,{})})]})});t.displayName="Callout";const ge=o.div`
  display: flex;
