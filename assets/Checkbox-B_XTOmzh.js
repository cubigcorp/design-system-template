import{j as n}from"./jsx-runtime-WsICpuy1.js";import{d as f}from"./styled-components.browser.esm-BDiU6mDK.js";import{c as e}from"./color-DqDZjiGS.js";import{t as l}from"./textColor-SSyLf7rE.js";import{b as i}from"./borderColor-CQKT7y1f.js";import{r as h}from"./radius-DaoU83SK.js";import{s as g}from"./spacing-tE1IiUFl.js";import"./IconSearch-DUeBiIsF.js";import{I as b}from"./IconCheck-eZFJJIcy.js";const c=({variant:r="secondary",state:o="unchecked",disabled:a=!1,onChange:t,className:d="",...s})=>{const u=()=>{if(a)return;const p=o!=="checked";t==null||t(p)},m=()=>o==="checked"?n.jsx(b,{width:16,height:16,color:"currentColor"}):null;return n.jsx(y,{$variant:r,$state:o,$disabled:a,onClick:u,className:d,...s,children:m()})},y=f.div`
  width: 16px;
  height: 16px;
