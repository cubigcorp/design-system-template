import{j as m}from"./jsx-runtime-D_zvdyIk.js";import{r as $,R as E}from"./iframe-DEeNHyDL.js";import{d as c,t as T}from"./textColor-hkqm2sl1.js";import{s as a}from"./spacing-tE1IiUFl.js";import{r as d}from"./radius-DaoU83SK.js";import{c as n}from"./color-CiwAFuFb.js";import"./negativeColor-C6enJIYV.js";import"./cautioniaryColor-DrCmYiBi.js";import"./borderColor-C_RHITEf.js";import"./layerColor-7aOJUZki.js";const g=({size:t="medium",disabled:e=!1,active:r=!1,onChange:o,onClick:s,onFocus:i,onBlur:f,className:v="",style:h,lang:I,...x})=>{const[l,u]=$.useState(r);E.useEffect(()=>{u(r)},[r]);const w=y=>{if(!e){const p=!l;u(p),o==null||o(p),s==null||s(y)}};return m.jsx(b,{$size:t,$disabled:e,$active:l,disabled:e,onClick:w,onFocus:i,onBlur:f,className:`switch ${v}`,style:h,...x,children:m.jsx(R,{$size:t,$disabled:e,$active:l})})},b=c.button`
  position: relative;
  border: none;
  outline: none;
