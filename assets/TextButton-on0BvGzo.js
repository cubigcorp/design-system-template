import{j as l}from"./jsx-runtime-BZyYZB_P.js";import{l as i,d as y}from"./styled-components.browser.esm-Ciw-Jg2d.js";import{c as e}from"./color-BKBaEAUu.js";import{r as B}from"./radius-DaoU83SK.js";import{f as d}from"./fontWeight-CRwBdwgF.js";import{f as p}from"./fontSize-BFAJJ5Eh.js";import{f as h}from"./fontFamily-CsG1KcIF.js";import{b as u}from"./borderColor-C94_pvKu.js";import{t as g}from"./textColor-C1-D1tBN.js";import{s as v}from"./spacing-tE1IiUFl.js";import{S as P}from"./Spinner-B3c51s_K.js";import{R as c}from"./iframe-Ck2s8rWu.js";import{b as F}from"./brandColor-B7_BrDA7.js";import{n as M,p as j}from"./negativeColor-CUiOZlpg.js";const D=y.button.withConfig({shouldForwardProp:r=>!["loading","state","radiusKey"].includes(r)})`
  display: inline-flex;
  align-items: center;
  ...
  ${({disabled:r,variant:a="primary"})=>r&&i`
      ...
      border-color: ${a==="primary"?e.gray[600]:u.light["color-border-primary"]} !important;
...
`,N=({variant:r="primary",size:a="medium",state:t="default",disabled:s=!1,loading:n=!1,leadingIcon:m,trailingIcon:f,label:w,children:$,onClick:x,className:S,radiusKey:b,lang:V})=>{const[T,o]=c.useState(t);c.useEffect(()=>{o(t)},[t]);const G=()=>{!s&&!n&&t==="default"&&o("hovered")},q=()=>{!s&&!n&&o(t)},C=()=>{!s&&!n&&t==="default"&&o("pressed")},E=()=>{!s&&!n&&t==="default"&&o("hovered")},k=()=>{!s&&!n&&t==="default"&&o("focused")},R=()=>{!s&&!n&&o(t)};return l.jsxs(D,{variant:r,size:a,state:t!=="default"?t:T,disabled:s,loading:n,radiusKey:b,lang:V,onClick:x,className:S,onMouseEnter:G,onMouseLeave:q,onMouseDown:C,onMouseUp:E,onFocus:k,onBlur:R,children:[l.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",opacity:n?0:1,transition:"opacity 0.2s ease"},children:[m&&c.createElement(m),l.jsx(z,{children:$||w}),f&&c.createElement(f)]}),l.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",opacity:n?1:0,transition:"opacity 0.2s ease"},children:l.jsx(P,{})})]})};N.__docgenInfo={description:"",methods:[],displayName:"SolidButton",props:{variant:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "brand"
| "positive"
...
`,K=y.span`
  padding: 0 ${v.gap["gap-0.5"]};
`,L=({variant:r="primary",size:a="medium",state:t="default",disabled:s=!1,loading:n=!1,leadingIcon:m,trailingIcon:f,label:w,children:$,onClick:x,className:S,radiusKey:b,lang:V})=>{const[T,o]=c.useState(t);c.useEffect(()=>{o(t)},[t]);const G=()=>{!s&&!n&&t==="default"&&o("hovered")},q=()=>{!s&&!n&&o(t)},C=()=>{!s&&!n&&t==="default"&&o("pressed")},E=()=>{!s&&!n&&t==="default"&&o("hovered")},k=()=>{!s&&!n&&t==="default"&&o("focused")},R=()=>{!s&&!n&&o(t)};return l.jsxs(I,{variant:r,size:a,state:t!=="default"?t:T,disabled:s,loading:n,radiusKey:b,onClick:x,className:S,lang:V,onMouseEnter:G,onMouseLeave:q,onMouseDown:C,onMouseUp:E,onFocus:k,onBlur:R,children:[l.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",opacity:n?0:1,transition:"opacity 0.2s ease"},children:[m&&c.createElement(m),l.jsx(K,{children:$||w}),f&&c.createElement(f)]}),l.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",opacity:n?1:0,transition:"opacity 0.2s ease"},children:l.jsx(P,{})})]})};L.__docgenInfo={description:"",methods:[],displayName:"OutlineButton",props:{variant:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "brand"
| "positive"
...
`,_=y.span`
  padding: 0 ${v.gap["gap-0.5"]};
`,W=({variant:r="primary",size:a="medium",state:t="default",disabled:s=!1,loading:n=!1,leadingIcon:m,trailingIcon:f,label:w,children:$,onClick:x,className:S,radiusKey:b,lang:V})=>{const[T,o]=c.useState(t);c.useEffect(()=>{o(t)},[t]);const G=()=>{!s&&!n&&t==="default"&&o("hovered")},q=()=>{!s&&!n&&o(t)},C=()=>{!s&&!n&&t==="default"&&o("pressed")},E=()=>{!s&&!n&&t==="default"&&o("hovered")},k=()=>{!s&&!n&&t==="default"&&o("focused")},R=()=>{!s&&!n&&o(t)};return l.jsxs(U,{variant:r,size:a,state:t!=="default"?t:T,disabled:s,loading:n,radiusKey:b,onClick:x,className:S,lang:V,onMouseEnter:G,onMouseLeave:q,onMouseDown:C,onMouseUp:E,onFocus:k,onBlur:R,children:[l.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",opacity:n?0:1,transition:"opacity 0.2s ease"},children:[m&&c.createElement(m),l.jsx(_,{children:$||w}),f&&c.createElement(f)]}),l.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",opacity:n?1:0,transition:"opacity 0.2s ease"},children:l.jsx(P,{})})]})};W.__docgenInfo={description:"",methods:[],displayName:"TextButton",props:{variant:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "brand"
| "positive"
