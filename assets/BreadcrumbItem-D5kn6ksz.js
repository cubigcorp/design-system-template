import{j as N}from"./jsx-runtime-D_zvdyIk.js";import{R as i}from"./iframe-B5hpKK9d.js";import{t as a,l as o,d as x}from"./textColor-DPyvHAOL.js";import{c as l}from"./color-CiwAFuFb.js";import{s as c}from"./spacing-tE1IiUFl.js";import{r as M}from"./radius-DaoU83SK.js";import{t as q}from"./typography-BBThIZ7c.js";const u=i.forwardRef(({children:t,onClick:n,active:s=!1,disabled:e=!1,leadingIcon:d,trailingIcon:p,className:f,...g},m)=>{const[h,r]=i.useState("default"),$=()=>{e||r("hovered")},y=()=>{e||r("default")},v=()=>{e||r("pressed")},R=()=>{e||r("hovered")},b=()=>{e||r("focused")},w=()=>{e||r("default")},k=()=>{!e&&n&&n()};return N.jsxs(B,{ref:m,className:f,$state:h,$active:s,$disabled:e,onMouseEnter:$,onMouseLeave:y,onMouseDown:v,onMouseUp:R,onFocus:b,onBlur:w,onClick:k,disabled:e,...g,children:[d,t,p]})});u.displayName="BreadcrumbItem";const B=x.button.withConfig({shouldForwardProp:t=>!["$state","$active","$disabled"].includes(t)})`
  display: inline-flex;
  align-items: center;
  gap: ${c.gap["gap-1"]};
