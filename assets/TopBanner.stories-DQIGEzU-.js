import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./iframe-D0DrdOha.js";import{d as u}from"./styled-components.browser.esm-DPRVC5T4.js";import{c as I}from"./color-CiwAFuFb.js";import{S as V}from"./icon_close_outline_24-BuFst0bb.js";import"./preload-helper-eJNa_G2e.js";const _=({src:e,link:t,startDate:i,endDate:a,backgroundColor:o=I.gray[950],...c})=>{const[n,f]=r.useState(!1),[k,l]=r.useState(!0);r.useEffect(()=>{const b=new Date;if(i){const d=new Date(i);if(b<d){l(!1);return}}if(a){const d=new Date(a);if(b>d){l(!1);return}}l(!0)},[i,a]);const p=()=>{f(!1)},S=()=>{f(!0)},h=()=>{t&&window.open(t,"_blank","noopener,noreferrer")};return k?s.jsx(W,{$hasLink:!!t,$hasError:n,$backgroundColor:o,onClick:t?h:void 0,...c,children:n?s.jsx(P,{children:"배너 이미지를 불러올 수 없습니다"}):s.jsx(H,{src:e,alt:"배너",onLoad:p,onError:S})}):null},W=u.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
