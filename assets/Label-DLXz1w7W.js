import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as t}from"./styled-components.browser.esm-o0t8qbnT.js";import{t as n}from"./textColor-DLZeZODc.js";import{t as r}from"./typography-CHdGJV44.js";import{s as o}from"./spacing-tE1IiUFl.js";import{c as m}from"./color-CiwAFuFb.js";const i=({children:a,type:l="default",className:s="",lang:p,...d})=>{const u=p,c=()=>{switch(l){case"required":return e.jsxs(e.Fragment,{children:[e.jsx("span",{children:a}),e.jsx(g,{children:"*"})]});case"optional":return e.jsxs(e.Fragment,{children:[e.jsx("span",{children:a}),e.jsx(x,{children:"(선택)"})]});default:return e.jsx("span",{children:a})}};return e.jsx(f,{$type:l,lang:u,className:s,...d,children:c()})},f=t.label`
