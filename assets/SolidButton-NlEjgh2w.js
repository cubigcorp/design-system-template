import{j as u}from"./jsx-runtime-D_zvdyIk.js";import{l,d as h}from"./styled-components.browser.esm-BYbGDw5M.js";import{c as e}from"./color-CiwAFuFb.js";import{r as j}from"./radius-DaoU83SK.js";import{f as d}from"./fontWeight-CRwBdwgF.js";import{f as p}from"./fontSize-BFAJJ5Eh.js";import{f as g}from"./fontFamily-CsG1KcIF.js";import{b as i}from"./borderColor-C_RHITEf.js";import{t as y}from"./textColor-DLZeZODc.js";import{s as v}from"./spacing-tE1IiUFl.js";import{S as M}from"./Spinner-DHoirSy7.js";import{R as c}from"./iframe-DqVVvM-u.js";const B=h.button.withConfig({shouldForwardProp:a=>!["loading","state","radiusKey"].includes(a)})`
  display: inline-flex;
  align-items: center;
  ...
  ${({size:a="medium"})=>{switch(a){case"small":return l`
          padding: 6px 12px;
          height: 32px;
          font-size: ${p.t4[0]};
          font-weight: ${d[500]};
  ...
  // 비활성화 상태
  ${({disabled:a,variant:r="primary"})=>a&&l`
      ...
      color: ${r==="primary"?e.gray[500]:y.light["fg-neutral-disable"]} !important;
      pointer-events: none;
      cursor: not-allowed;
    `}
...
`,z=({variant:a="primary",size:r="medium",state:t="default",disabled:o=!1,loading:n=!1,leadingIcon:m,trailingIcon:f,label:w,children:x,onClick:S,className:b,radiusKey:V,lang:$})=>{const[T,s]=c.useState(t);c.useEffect(()=>{s(t)},[t]);const G=()=>{!o&&!n&&t==="default"&&s("hovered")},q=()=>{!o&&!n&&s(t)},C=()=>{!o&&!n&&t==="default"&&s("pressed")},E=()=>{!o&&!n&&t==="default"&&s("hovered")},R=()=>{!o&&!n&&t==="default"&&s("focused")},k=()=>{!o&&!n&&s(t)};return u.jsxs(B,{variant:a,size:r,state:t!=="default"?t:T,disabled:o,loading:n,radiusKey:V,lang:$,onClick:S,className:b,onMouseEnter:G,onMouseLeave:q,onMouseDown:C,onMouseUp:E,onFocus:R,onBlur:k,children:[u.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",opacity:n?0:1,transition:"opacity 0.2s ease"},children:[m&&c.createElement(m),u.jsx(P,{children:x||w}),f&&c.createElement(f)]}),u.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",opacity:n?1:0,transition:"opacity 0.2s ease"},children:u.jsx(M,{})})]})};z.__docgenInfo={description:"",methods:[],displayName:"SolidButton",props:{variant:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "tertiary"
| "brand"
| "positive"
