import{j as e}from"./jsx-runtime-CL3neUek.js";import{r as V}from"./iframe-BQesNdA-.js";import{d as W}from"./styled-components.browser.esm-Dm9YJfy-.js";import{c}from"./color-DqDZjiGS.js";import{t as h}from"./textColor-SSyLf7rE.js";import{b as g}from"./borderColor-CQKT7y1f.js";import{r as q}from"./radius-DaoU83SK.js";import{s as N}from"./spacing-tE1IiUFl.js";import{I as _}from"./IconSearch-BtgbHis2.js";const n=({variant:a="secondary",state:r="unchecked",disabled:s=!1,onChange:t,className:m="",...y})=>{const u=()=>{if(s)return;const l=r!=="checked";t==null||t(l)},f=()=>r==="checked"?e.jsx(_,{width:16,height:16,color:"currentColor"}):null;return e.jsx(E,{$variant:a,$state:r,$disabled:s,onClick:u,className:m,...y,children:f()})},E=W.div`
  width: 16px;
  height: 16px;
