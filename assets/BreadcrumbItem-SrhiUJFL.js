import{j as k}from"./jsx-runtime-D_zvdyIk.js";import{R as c}from"./iframe-BTdZdBan.js";import{t as o,l as t,d as x}from"./textColor-Bu4n0d9i.js";import{c as i}from"./color-CiwAFuFb.js";import{s}from"./spacing-tE1IiUFl.js";import{r as M}from"./radius-DaoU83SK.js";import{t as q}from"./typography-BBThIZ7c.js";const l=c.forwardRef(({children:a,onClick:n,active:d=!1,disabled:e=!1,leadingIcon:u,trailingIcon:p,className:f,...m},g)=>{const[h,r]=c.useState("default"),$=()=>{e||r("hovered")},y=()=>{e||r("default")},v=()=>{e||r("pressed")},R=()=>{e||r("hovered")},b=()=>{e||r("focused")},w=()=>{e||r("default")},N=()=>{!e&&n&&n()};return k.jsxs(B,{ref:g,className:f,$state:h,$active:d,$disabled:e,onMouseEnter:$,onMouseLeave:y,onMouseDown:v,onMouseUp:R,onFocus:b,onBlur:w,onClick:N,disabled:e,...m,children:[u,a,p]})});l.displayName="BreadcrumbItem";const B=x.button.withConfig({shouldForwardProp:a=>!["$state","$active","$disabled"].includes(a)})`
  display: inline-flex;
  align-items: center;
  gap: ${s.gap["gap-1"]};
