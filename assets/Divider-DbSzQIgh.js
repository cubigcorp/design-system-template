import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as m}from"./iframe-C8Me4DqF.js";import{d as s,l as P}from"./styled-components.browser.esm-DPhkORiP.js";import{L as D,D as G}from"./Description-CgLGaLBF.js";import{c as f}from"./color-CiwAFuFb.js";import{t as r}from"./textColor-DLZeZODc.js";import"./brandColor-OQPP65_V.js";import{p as H,n as A}from"./negativeColor-DPOOrHeE.js";import"./cautioniaryColor-DrCmYiBi.js";import{b as g}from"./borderColor-C_RHITEf.js";import"./layerColor-7aOJUZki.js";import{f as h}from"./fontFamily-CsG1KcIF.js";import{t as v}from"./typography-BBThIZ7c.js";import{r as N}from"./radius-DaoU83SK.js";import{s as i}from"./spacing-tE1IiUFl.js";import{a as W,I as Y,b as J,c as K,d as Q,e as U}from"./IconSearch-D4pbJy3T.js";import"./IconCheck-CKtc9n1_.js";import{A as X}from"./Avatar-yNaO_PnA.js";const F=m.forwardRef(({size:e="medium",status:t="default",disabled:n=!1,active:l=!1,focused:o=!1,placeholder:c,value:d,type:u="text",onChange:b,onFocus:x,onBlur:$,className:w="",lang:I,...j},R)=>{const[k,C]=m.useState(!1),[E,q]=m.useState(o);m.useEffect(()=>{q(o)},[o]);const T=y=>{q(!0),x==null||x(y)},S=y=>{q(!1),$==null||$(y)},p=u==="password"&&d&&d.trim()!==""?{icon:k?"visibility-on":"visibility-off",color:r.light["fg-neutral-primary"]}:n?t==="positive"?{icon:"circlecheck",color:H.light["fg-positive-primary"]}:null:t==="negative"?l?null:{icon:"error",color:A.light["fg-negative-primary"]}:t==="positive"?l?null:{icon:"circlecheck",color:H.light["fg-positive-primary"]}:null,V=I;return a.jsxs(Z,{children:[a.jsx(z,{ref:R,type:u==="password"?k?"text":"password":u,value:d,onChange:b,onFocus:T,onBlur:S,placeholder:c,disabled:n,className:w,$size:e,$status:t,$disabled:n,$active:l,$focused:E,lang:V,...Object.fromEntries(Object.entries(j).filter(([y])=>!["active","focused","status","size"].includes(y)))}),p&&a.jsxs(ee,{$size:e,$color:p.color,onMouseDown:y=>{y.preventDefault(),(p.icon==="visibility-on"||p.icon==="visibility-off")&&C(!k)},type:"button",children:[p.icon==="error"&&a.jsx(W,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:p.color}),p.icon==="circlecheck"&&a.jsx(Y,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:p.color}),p.icon==="visibility-on"&&a.jsx(J,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:p.color}),p.icon==="visibility-off"&&a.jsx(K,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:p.color})]})]})}),Z=s.div`
  position: relative;
