import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./iframe-D4fn7yV1.js";import{d as a}from"./styled-components.browser.esm-kr1dGAPk.js";import{I as Fe,T as Xe,t as Ne}from"./ToastSystem-DnwVdb30.js";import{c as r}from"./color-CiwAFuFb.js";import{b as $e}from"./borderColor-C_RHITEf.js";import{r as x}from"./radius-DaoU83SK.js";import{s as Ee}from"./shadow-DVq_1U2q.js";import{s as o}from"./spacing-tE1IiUFl.js";import{a as Te}from"./typography-CHdGJV44.js";import{t as Ie}from"./textColor-DLZeZODc.js";import{O as d}from"./OutlineButton-mOlzk-2Z.js";import{S as p}from"./SolidButton-D1SVUeYo.js";import{D as T}from"./Dropdown-CWEUZllt.js";import"./preload-helper-eJNa_G2e.js";import"./IconCircleCheck-BBUUqRs3.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./lineHeight-aJXO3HIm.js";import"./brandColor-OQPP65_V.js";import"./negativeColor-DPOOrHeE.js";import"./Spinner-DQZNpWi0.js";import"./Label-DuxyECrx.js";import"./ComboBox-DkouNHtA.js";import"./index-CBWCOHxf.js";import"./index-BNvNhXiF.js";import"./IconArrowUp-Cts_pkXJ.js";import"./Menu-BYY7_Vqi.js";import"./Cell-BV7wrYUI.js";import"./IconCheck-Cgh-IEDk.js";import"./MultiSelect-JSy0k5zc.js";import"./Chip-Bp8naTDX.js";import"./icon_close_outline_16-DNJwG45e.js";import"./Selector-BadruZsV.js";import"./Description-Di0jRj-Y.js";const De={light:{"bg-layer-basement":r.gray[50],"bg-layer-fill":r.gray[25],"bg-layer-floating":r.common[100],"bg-overlay":r.common.dimmer},dark:{"bg-layer-basement":r.gray[990],"bg-layer-default":r.gray[975],"bg-layer-fill":r.gray[950],"bg-layer-floating":r.gray[975]}},g=({size:n="medium",position:l="center",open:s=!1,onClose:i,title:D="제목",description:f,showCloseButton:L=!0,children:V,actions:m,className:q="",style:h,...F})=>{const[y,X]=u.useState(!1),[Le,N]=u.useState(!1);if(u.useEffect(()=>{if(s){N(!0);const c=setTimeout(()=>{X(!0)},10);return()=>clearTimeout(c)}else{X(!1);const c=setTimeout(()=>{N(!1)},200);return()=>clearTimeout(c)}},[s]),!Le)return null;const Ve=c=>{if(c.target.closest("[data-portal-menu]")){c.preventDefault(),c.stopPropagation();return}c.target===c.currentTarget&&(i==null||i())},qe=()=>{i==null||i()};return e.jsx(Pe,{$isVisible:y,$position:l,onMouseDown:Ve,children:e.jsxs(He,{$size:n,$isVisible:y,className:q,style:h,...F,children:[e.jsxs(_e,{children:[e.jsxs(Ge,{children:[e.jsx(Je,{children:D}),f&&e.jsx(Ke,{children:f})]}),L&&e.jsx(Qe,{onClick:qe,children:e.jsx(Fe,{width:24,height:24,color:"currentColor"})})]}),e.jsx(Ue,{children:V}),m&&e.jsx(Ye,{children:m})]})})},Pe=a.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
