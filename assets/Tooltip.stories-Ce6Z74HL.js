import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as p}from"./iframe-BW59HvWr.js";import{r as U}from"./index-n2NQl2Z2.js";import{d as g,l as $,m as X}from"./styled-components.browser.esm-LFH3Vo6z.js";import{c as b}from"./color-CiwAFuFb.js";import{t as S}from"./textColor-DLZeZODc.js";import"./brandColor-OQPP65_V.js";import"./negativeColor-DPOOrHeE.js";import"./cautioniaryColor-DrCmYiBi.js";import{b as Y}from"./borderColor-C_RHITEf.js";import"./layerColor-7aOJUZki.js";import{t as O}from"./typography-RVdj8V17.js";import{r as Z}from"./radius-DaoU83SK.js";import{s as T}from"./spacing-tE1IiUFl.js";import{S as n}from"./SolidButton-BMI0LqLP.js";import"./index-XOCDTUM8.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./fontFamily-CsG1KcIF.js";import"./lineHeight-aJXO3HIm.js";import"./Spinner-CLMa4i3o.js";const tt=X`
  from {
    opacity: 0;
  }
  to {
...
`,o=({children:r,text:A,hotkey:B,variant:x="primary",placement:j="bottom-left",offset:a=4,className:F})=>{const[y,R]=p.useState(!1),[k,G]=p.useState({top:0,left:0}),f=p.useRef(null),v=p.useRef(null),J=()=>{if(!f.current||!v.current)return;const e=f.current.getBoundingClientRect(),i=v.current.getBoundingClientRect();let l=0,s=0;switch(j){case"top-left":l=e.top-i.height-a,s=e.left;break;case"top-center":l=e.top-i.height-a,s=e.left+(e.width-i.width)/2;break;case"top-right":l=e.top-i.height-a,s=e.right-i.width;break;case"bottom-left":l=e.bottom+a,s=e.left;break;case"bottom-center":l=e.bottom+a,s=e.left+(e.width-i.width)/2;break;case"bottom-right":l=e.bottom+a,s=e.right-i.width;break;case"left":l=e.top+(e.height-i.height)/2,s=e.left-i.width-a;break;case"right":l=e.top+(e.height-i.height)/2,s=e.right+a;break}G({top:l,left:s})};p.useEffect(()=>{y&&J()},[y,j,a]);const K=()=>{R(!0)},Q=()=>{R(!1)};return t.jsxs(et,{ref:f,onMouseEnter:K,onMouseLeave:Q,className:F,children:[r,y&&U.createPortal(t.jsxs(ot,{ref:v,$variant:x,style:{top:k.top,left:k.left},children:[t.jsx(rt,{$variant:x,children:A}),B&&t.jsx(nt,{$variant:x,children:B})]}),document.body)]})},et=g.div`
  position: relative;
  display: inline-flex;
`,ot=g.div`
  position: fixed;
...
}`,...(z=(W=h.parameters)==null?void 0:W.docs)==null?void 0:z.source}}};const $t=["Primary","Secondary","WithHotkey","Placements","Variants"];export{u as Placements,c as Primary,d as Secondary,h as Variants,m as WithHotkey,$t as __namedExportsOrder,kt as default};
