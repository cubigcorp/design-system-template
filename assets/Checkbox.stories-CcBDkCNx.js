import{j as e}from"./jsx-runtime-CpEw07D7.js";import{r as V}from"./iframe-_QIr2-1u.js";import{d as W}from"./styled-components.browser.esm-oRgFu6Fw.js";import{c}from"./color-DlZ4f652.js";import{t as h}from"./textColor-DVi7834n.js";import{b as g}from"./borderColor-BrY1a26q.js";import{r as q}from"./radius-DaoU83SK.js";import{s as N}from"./spacing-tE1IiUFl.js";import{I as _}from"./IconSearch-BpPNvS-z.js";const n=({variant:a="secondary",state:r="unchecked",disabled:s=!1,onChange:t,className:m="",...y})=>{const u=()=>{if(s)return;const l=r!=="checked";t==null||t(l)},f=()=>r==="checked"?e.jsx(_,{width:16,height:16,color:"currentColor"}):null;return e.jsx(E,{$variant:a,$state:r,$disabled:s,onClick:u,className:m,...y,children:f()})},E=W.div`
  width: 16px;
  height: 16px;
  ...
  ${({$variant:a,$state:r,$disabled:s})=>s?`
      ...
      `:a==="primary"?r==="checked"?`
        ...
        `:`
          ...
          border: 1px solid ${g.light["color-border-primary"]};
          color: ${h.light["fg-neutral-strong"]};
        `:`
      background-color: ${c.common[100]};
      border: 1px solid ${g.light["color-border-primary"]};
      color: ${h.light["fg-neutral-strong"]};
...
}`,...(A=(w=x.parameters)==null?void 0:w.docs)==null?void 0:A.source}}};const X=["Default","AllStates","AllVariants","AllCombinations","Interactive"];export{p as AllCombinations,o as AllStates,d as AllVariants,i as Default,x as Interactive,X as __namedExportsOrder,Q as default};
