import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as r,p as z}from"./styled-components.browser.esm-1f8qeTbm.js";import{c as f}from"./color-m2U5piog.js";import"./iframe-skmiukBS.js";import"./preload-helper-eJNa_G2e.js";const D={small:16,medium:20,large:24,"x-large":32},w={small:4,medium:6,large:8,"x-large":10},l=({type:n="spinner",size:t="medium",color:S,className:x})=>{const a=S||f.gray[950];if(n==="dots"){const o=w[t],$=Math.max(4,o/2);return e.jsxs(B,{className:x,$gap:$,children:[e.jsx(y,{$size:o,$color:a,$delay:"0s"}),e.jsx(y,{$size:o,$color:a,$delay:"0.15s"}),e.jsx(y,{$size:o,$color:a,$delay:"0.3s"})]})}const i=D[t],p=Math.max(2,i/8),m=(i-p)/2,g=2*Math.PI*m;return e.jsx(L,{className:x,$size:i,children:e.jsxs(F,{viewBox:`0 0 ${i} ${i}`,children:[e.jsx("circle",{cx:i/2,cy:i/2,r:m,fill:"none",stroke:f.gray[200],strokeWidth:p}),e.jsx(C,{cx:i/2,cy:i/2,r:m,fill:"none",stroke:a,strokeWidth:p,strokeLinecap:"round",strokeDasharray:`${g*.25} ${g*.75}`})]})})},T=z`
  0% {
