import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./iframe-Diu4OQ1h.js";import{c as o}from"./styled-components.browser.esm-DZloA45Z.js";import{I as ee,T as te,t as ne}from"./ToastSystem-CcOAeYpf.js";import{c as r}from"./color-BUCiRq0z.js";import{b as _}from"./borderColor-Bua6bgaN.js";import{r as x}from"./radius-DaoU83SK.js";import{s as ie}from"./shadow-DVq_1U2q.js";import{s as a}from"./spacing-tE1IiUFl.js";import{a as G}from"./typography-CHdGJV44.js";import{t as re}from"./textColor-mWadn7SX.js";import{O as m,S as s}from"./SolidButton-BApmGIO5.js";import{T as M}from"./TextField-Cca-NC-V.js";import{D as ae}from"./Dropdown-BFf-fJ2B.js";import{T as se}from"./TextButton-pF4mtMsO.js";import"./preload-helper-eJNa_G2e.js";import"./IconCircleCheck-BBUUqRs3.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./lineHeight-aJXO3HIm.js";import"./brandColor-C6bU0fYs.js";import"./negativeColor-PFzGnuZM.js";import"./types-JZURDx2G.js";import"./Label-CbpmhvAg.js";import"./Input-CN8e2Ym_.js";import"./Description-BngmAm2p.js";import"./ComboBox-CRgngDA3.js";import"./index-BCNg7JgI.js";import"./index-Bpka59JO.js";import"./IconArrowUp-Cts_pkXJ.js";import"./Menu-ChLRBgia.js";import"./Cell-CnVmU1QJ.js";import"./IconCheck-Cgh-IEDk.js";import"./MultiSelect-ziB4o5ko.js";import"./Chip-Js6mrB2Q.js";import"./icon_close_outline_16-Jo-UaxxG.js";import"./Selector-CdNLfucG.js";const J={light:{"bg-layer-basement":r.gray[50],"bg-layer-fill":r.gray[25],"bg-layer-floating":r.common[100],"bg-overlay":r.common.dimmer},dark:{"bg-layer-basement":r.gray[990],"bg-layer-default":r.gray[975],"bg-layer-fill":r.gray[950],"bg-layer-floating":r.gray[975]}},y=({size:n="medium",position:i="center",open:d=!1,onClose:l,title:p="제목",description:v,showCloseButton:h=!0,children:f,actions:C,className:K="",style:Q,...U})=>{const[O,$]=u.useState(!1),[X,w]=u.useState(!1);if(u.useEffect(()=>{if(d){w(!0);const c=setTimeout(()=>{$(!0)},10);return()=>clearTimeout(c)}else{$(!1);const c=setTimeout(()=>{w(!1)},200);return()=>clearTimeout(c)}},[d]),!X)return null;const Y=c=>{if(c.target.closest("[data-portal-menu]")){c.preventDefault(),c.stopPropagation();return}c.target===c.currentTarget&&(l==null||l())},Z=()=>{l==null||l()};return e.jsx(le,{$isVisible:O,$position:i,onMouseDown:Y,children:e.jsxs(oe,{$size:n,$isVisible:O,className:K,style:Q,...U,children:[e.jsxs(de,{children:[e.jsxs(ce,{children:[e.jsx(pe,{children:p}),v&&e.jsx(me,{children:v})]}),h&&e.jsx(ge,{onClick:Z,children:e.jsx(ee,{width:24,height:24,color:"currentColor"})})]}),e.jsx(ue,{children:f}),C&&e.jsx(ye,{children:C})]})})},le=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
}`,...(D=(F=j.parameters)==null?void 0:F.docs)==null?void 0:D.source}}};var L,A,N;B.parameters={...B.parameters,docs:{...(L=B.parameters)==null?void 0:L.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(N=(A=B.parameters)==null?void 0:A.docs)==null?void 0:N.source}}};var q,P,I;S.parameters={...S.parameters,docs:{...(q=S.parameters)==null?void 0:q.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
