import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{r as o,R as W}from"./iframe-CCQJzrSR.js";import{r as Y}from"./index-D2lpCdh2.js";import{c as v}from"./styled-components.browser.esm-f0aNwSj6.js";import{I as _,a as G}from"./IconArrowUp-Cts_pkXJ.js";import{M as U}from"./Menu-CrNfYB6b.js";import{C as X}from"./Cell-iXa5SZU0.js";import{r as B}from"./radius-DaoU83SK.js";import{c as r}from"./color-m2U5piog.js";import{s as a}from"./spacing-tE1IiUFl.js";import{t as T}from"./typography-CHdGJV44.js";import{t as s}from"./textColor-G8dwupNW.js";import{b as p}from"./borderColor-CzkI5wcR.js";const M=({size:e="medium",status:l="default",disabled:i=!1,active:d=!1,focused:u=!1,placeholder:P="선택해주세요.",value:S,options:k=[],onChange:w,onFocus:y,onBlur:m,className:L="",style:I,lang:V="ko",showCheckIcon:O=!0,...H})=>{const[g,b]=o.useState(!1),[R,$]=o.useState(d),[A,h]=o.useState(u),[x,F]=o.useState({top:0,left:0,width:0}),f=o.useRef(null),E=o.useRef(null);o.useEffect(()=>{const t=c=>{const j=c.target;E.current&&E.current.contains(j)||f.current&&!f.current.contains(j)&&(b(!1),h(!1))};return document.addEventListener("mousedown",t),()=>{document.removeEventListener("mousedown",t)}},[]),o.useEffect(()=>{$(d)},[d]),o.useEffect(()=>{h(u)},[u]),o.useEffect(()=>{if(g&&f.current){const t=()=>{if(f.current){const c=f.current.getBoundingClientRect();F({top:c.bottom+window.scrollY,left:c.left+window.scrollX,width:c.width})}};return t(),window.addEventListener("scroll",t,!0),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t,!0),window.removeEventListener("resize",t)}}},[g]);const C=k.find(t=>t.value===S),D=()=>{i||(b(!g),g?(h(!1),$(!1),m==null||m({})):(h(!0),$(!0),y==null||y({})))},N=t=>{w==null||w(t.value),b(!1),h(!1),m==null||m({})},q=()=>i?s.light["fg-neutral-alternative"]:s.light["fg-neutral-primary"];return n.jsxs(J,{ref:f,className:`selector-container ${L}`,style:I,...H,children:[n.jsxs(Z,{$size:e,$status:l,$disabled:i,$active:R,$focused:A,lang:V,onClick:D,type:"button","data-active":R?"true":"false",children:[n.jsx(z,{children:C?C.label:P}),n.jsx(ee,{size:e,children:g?n.jsx(_,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:q()}):n.jsx(G,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:q()})})]}),g&&Y.createPortal(n.jsx(Q,{ref:E,onMouseDown:t=>t.stopPropagation(),onMouseDownCapture:t=>t.stopPropagation(),onClick:t=>t.stopPropagation(),"data-portal-menu":!0,$top:x.top,$left:x.left,$width:x.width,children:n.jsx(U,{showCheckIcon:O,children:k.map(t=>n.jsx(X,{text:t.label,description:t.description,leadingContent:t.leadingContent,active:t.value===S,onClick:c=>{c.stopPropagation(),N(t)}},t.value))})}),document.body)]})},J=v.div`
  position: relative;
  display: flex;
