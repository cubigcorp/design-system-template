import{j as a}from"./jsx-runtime-CGmPDQQA.js";import{r as y}from"./iframe-BE39lfRy.js";import{d as c}from"./styled-components.browser.esm-BnnUhwQ2.js";import{c as b}from"./color-CMFzNX_O.js";import{t as r,b as u}from"./borderColor-C1c8KEhD.js";import{t as p}from"./typography-BtvHU1C6.js";import{s as o}from"./spacing-tE1IiUFl.js";import{p as v,n as T}from"./negativeColor-vAhOVlFC.js";import{r as O}from"./radius-DaoU83SK.js";import{b as H,c as V,d as A}from"./IconRemove-HQND5J0n.js";const R=({children:e,type:l="default",className:n="",...t})=>{const i=()=>{switch(l){case"required":return a.jsxs(a.Fragment,{children:[a.jsx("span",{children:e}),a.jsx(G,{children:"*"})]});case"optional":return a.jsxs(a.Fragment,{children:[a.jsx("span",{children:e}),a.jsx(P,{children:"(선택)"})]});default:return a.jsx("span",{children:e})}};return a.jsx(B,{$type:l,className:n,...t,children:i()})},B=c.label`
  ${p.body2}
  height: 20px;
  display: flex;
  align-items: center;
