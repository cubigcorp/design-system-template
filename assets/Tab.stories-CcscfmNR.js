import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{R as l}from"./iframe-D0ynm1mK.js";import{c as $,s as m}from"./styled-components.browser.esm-o0t8qbnT.js";import{c as xe}from"./color-CiwAFuFb.js";import{s as N}from"./spacing-tE1IiUFl.js";import{t as v}from"./textColor-DLZeZODc.js";import{t as he}from"./typography-CHdGJV44.js";import"./preload-helper-eJNa_G2e.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./lineHeight-aJXO3HIm.js";const Ie=$.div`
  display: flex;
...
`,ge=$.div`
  ...
  left: ${({$left:n})=>n}px;
  width: ${({$width:n})=>n}px;
`,t=({children:n,className:r,defaultValue:o=0,value:d,onChange:i,showDivider:V=!0,...me})=>{const[ue,be]=l.useState(o),w=d!==void 0?d:ue,C=l.useRef([]),[D,pe]=l.useState({left:0,width:0}),Te=s=>{d===void 0&&be(s),i==null||i(s)},S=l.Children.toArray(n),k=S.slice(0,8);return S.length>8&&console.warn(`Tab: 최대 8개 이하의 탭만 허용됩니다. ${S.length}개 중 8개만 표시됩니다. 8개 이상 항목이 필요한 경우 드롭다운(Select) 컴포넌트 사용을 고려하세요.`),l.useEffect(()=>{const s=C.current[w];s&&pe({left:s.offsetLeft,width:s.offsetWidth})},[w,k.length]),e.jsxs(Ie,{className:r,$showDivider:V,...me,children:[e.jsx(ge,{$left:D.left,$width:D.width}),k.map((s,c)=>l.isValidElement(s)?l.cloneElement(s,{key:c,active:w===c,onClick:()=>Te(c),ref:fe=>{C.current[c]=fe}}):s)]})};t.__docgenInfo={description:"",methods:[],displayName:"Tab",props:{defaultValue:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},value:{required:!1,tsType:{name:"number"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(index: number) => void",signature:{arguments:[{type:{name:"number"},name:"index"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""},showDivider:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}},composes:["Omit"]};const je=$.button`
  display: flex;
  align-items: center;
...
}`,...(re=(te=g.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};var se,oe,le;j.parameters={...j.parameters,docs:{...(se=j.parameters)==null?void 0:se.docs,source:{originalSource:`{
  render: ({
    defaultValue
...
}`,...(le=(oe=j.parameters)==null?void 0:oe.docs)==null?void 0:le.source}}};var de,ie,ce;y.parameters={...y.parameters,docs:{...(de=y.parameters)==null?void 0:de.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '32px'
