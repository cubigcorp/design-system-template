import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{R as j}from"./iframe-UFqvfvuv.js";import{d as i}from"./styled-components.browser.esm-D8ZTpw4b.js";import"./IconSearch-D4pbJy3T.js";import"./IconCheck-CKtc9n1_.js";import{S as $}from"./icon_chevron-right_outline_20-nhYubz-F.js";import{b as c,c as C,a as I,S as w}from"./icon_warning_fill_20-63BlOSuw.js";import{s as n}from"./spacing-tE1IiUFl.js";import{r as T}from"./radius-DaoU83SK.js";import{c as r}from"./color-CiwAFuFb.js";import{t as a}from"./textColor-DLZeZODc.js";import{t as p}from"./typography-RVdj8V17.js";import{n as o,p as s}from"./negativeColor-DPOOrHeE.js";const g=j.forwardRef(({variant:e="default",title:d,description:l,leadingIcon:u=!0,trailingIcon:f=!1,onTrailingIconClick:m,className:v,...h},y)=>{const x=()=>{if(!u)return null;switch(e){case"positive":return t.jsx(w,{});case"negative":return t.jsx(I,{});case"cautionary":return t.jsx(C,{});case"info":return t.jsx(c,{});default:return t.jsx(c,{})}};return t.jsxs(b,{ref:y,className:v,$variant:e,...h,children:[u&&t.jsx(q,{$variant:e,children:x()}),t.jsxs(S,{children:[t.jsx(k,{$variant:e,children:d}),l&&t.jsx(R,{$variant:e,children:l})]}),f&&t.jsx(F,{onClick:m,$variant:e,children:t.jsx($,{})})]})});g.displayName="Callout";const b=i.div`
  display: flex;
...
`,q=i.div`
  ...
  flex-shrink: 0;
  padding-top: 2px;
  color: ${({$variant:e})=>{switch(e){case"positive":return s.light["fg-positive-primary"];case"negative":return o.light["fg-negative-primary"];case"cautionary":return r.orange[500];case"info":return r.blue[500];default:return a.light["fg-neutral-strong"]}}};
...
`,R=i.div`
  ...
  color: ${({$variant:e})=>{switch(e){case"positive":return r.green[500];case"negative":return r.red[400];case"cautionary":return r.orange[400];case"info":return r.blue[500];default:return a.light["fg-neutral-alternative"]}}};
`,F=i.div`
  display: flex;
  align-items: center;
  justify-content: center;
