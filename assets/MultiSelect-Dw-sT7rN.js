...
`,ce=d.input`
  ...
  ${({$disabled:t})=>t?`
        color: ${E.light["fg-neutral-disable"]};
        cursor: not-allowed;
      `:`
      color: ${E.light["fg-neutral-primary"]};
    `}

  &::placeholder {
    color: ${E.light["fg-neutral-assistive"]};
  }
`,de=d.div`
  position: absolute;
