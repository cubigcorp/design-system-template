import{j as r}from"./jsx-runtime-qV6SgEn1.js";import{r as h}from"./iframe-rmGbrFkh.js";import{d as s}from"./styled-components.browser.esm-88_Ulkpb.js";import{c as b}from"./color-CMFzNX_O.js";import{t as a,b as u}from"./borderColor-C1c8KEhD.js";import{t as T,a as R}from"./typography-he8MZv4l.js";import{s as o}from"./spacing-tE1IiUFl.js";import{p as x,n as L}from"./negativeColor-vAhOVlFC.js";import{r as A}from"./radius-DaoU83SK.js";import{a as H,b as N,c as B,d as G}from"./IconVisibilityOn-xI3g4Wn8.js";const k=({children:e,type:n="default",className:l="",...t})=>{const c=()=>{switch(n){case"required":return r.jsxs(r.Fragment,{children:[r.jsx("span",{children:e}),r.jsx(J,{children:"*"})]});case"optional":return r.jsxs(r.Fragment,{children:[r.jsx("span",{children:e}),r.jsx(K,{children:"(선택)"})]});default:return r.jsx("span",{children:e})}};return r.jsx(Y,{$type:n,className:l,...t,children:c()})},Y=s.label`
  ${T.body2}
  height: 20px;
  display: flex;
  align-items: center;
...
`,Z=s.input`
  ...
  /* Size styles */
  ${({$size:e})=>{const n=e==="large"?o.gap["gap-2.5"]:o.gap["gap-2"],t=(e==="small"?16:e==="large"?24:20)+parseInt(n)*2;switch(e){case"small":return`
          height: 32px;
          ${R("ko","body2","regular")}
