import{j as t}from"./jsx-runtime-ah8Vhd_4.js";import{r as c}from"./iframe-CKlQZ6zd.js";import{d as s,l as F,m as te}from"./styled-components.browser.esm-Cw_Beuop.js";import{c as u}from"./color-DlZ4f652.js";import{t as l,b}from"./borderColor-7dRAAa5F.js";import{p as D,n as G}from"./negativeColor-DFTQtxpe.js";import{f as M}from"./fontFamily-CsG1KcIF.js";import{t as E}from"./typography-5QY5Grkh.js";import{r as O}from"./radius-DaoU83SK.js";import{s as n}from"./spacing-tE1IiUFl.js";import{a as X,b as U,c as ce,d as pe,I as me,e as ae,f as re,g as fe,h as ge,i as he}from"./IconClose-C8d40_Tg.js";import{s as ne}from"./shadow-DVq_1U2q.js";const B=({children:e,type:a="default",className:r="",lang:i,...o})=>{const d=i,m=()=>{switch(a){case"required":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(ye,{children:"*"})]});case"optional":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(be,{children:"(선택)"})]});default:return t.jsx("span",{children:e})}};return t.jsx(ve,{$type:a,lang:d,className:r,...o,children:m()})},ve=s.label`
...
`;A.displayName="Menu";A.__docgenInfo={description:"",methods:[],displayName:"Menu",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const W=({disable:e=!1,active:a=!1,leadingIcon:r,text:i,description:o,trailingIcon:d,onClick:m,className:p,lang:$})=>{const f=()=>e?l.light["fg-neutral-disable"]:l.light["fg-neutral-primary"],q=()=>a&&!e;return t.jsxs(je,{disable:e,active:a,"data-disable":e,onClick:e?void 0:m,className:p,lang:$,children:[r&&t.jsx(Re,{children:t.jsx(r,{width:16,height:16,color:f()})}),t.jsxs(Ve,{children:[i&&t.jsx(Le,{children:i}),o&&t.jsx(Ce,{children:o})]}),q()&&t.jsx(Se,{children:d?t.jsx(d,{width:16,height:16,color:f()}):t.jsx(me,{width:16,height:16,color:f()})})]})},je=s.div`
  display: flex;
  align-items: center;
  gap: ${n.gap["gap-1"]};
...
`,Ae=s.div`
  ...
  cursor: pointer;
  pointer-events: auto;
`;Q.displayName="ComboBox";Q.__docgenInfo={description:"",methods:[],displayName:"ComboBox",props:{size:{required:!1,tsType:{name:"union",raw:'"small" | "medium" | "large"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},active:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},focused:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},placeholder:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"입력하거나 선택해주세요."',computed:!1}},value:{required:!1,tsType:{name:"string"},description:""},options:{required:!1,tsType:{name:"Array",elements:[{name:"ComboBoxOption"}],raw:"ComboBoxOption[]"},description:"",defaultValue:{value:"[]",computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},onFocus:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.FocusEvent<HTMLInputElement>) => void",signature:{arguments:[{type:{name:"ReactFocusEvent",raw:"React.FocusEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}]},name:"event"}],return:{name:"void"}}},description:""},onBlur:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.FocusEvent<HTMLInputElement>) => void",signature:{arguments:[{type:{name:"ReactFocusEvent",raw:"React.FocusEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}]},name:"event"}],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'""',computed:!1}},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""},lang:{required:!1,tsType:{name:"union",raw:'"ko" | "en"',elements:[{name:"literal",value:'"ko"'},{name:"literal",value:'"en"'}]},description:"",defaultValue:{value:'"ko"',computed:!1}}}};const oe=({type:e="selector",size:a="medium",disabled:r=!1,active:i=!1,focused:o=!1,placeholder:d="선택해주세요.",value:m,options:p=[],label:$,labelType:f="default",description:q,descriptionLeadingIcon:V=!1,status:j="default",onChange:S,onFocus:x,onBlur:v,className:L="",style:T,lang:R,...w})=>{const k=R;return t.jsxs(We,{className:`dropdown-container ${L}`,style:T,...Object.fromEntries(Object.entries(w).filter(([I])=>!["active","focused","size","disabled"].includes(I))),children:[$&&t.jsx(B,{type:f,lang:k,children:$}),e==="combobox"?t.jsx(Q,{size:a,disabled:r,active:i,focused:o,placeholder:d,value:m,options:p,onChange:S,onFocus:x,onBlur:v,lang:k}):t.jsx(J,{size:a,disabled:r,active:i,focused:o,placeholder:d,value:m,options:p,onChange:S,onFocus:x,onBlur:v,lang:k}),q&&t.jsx(P,{status:j,leadingIcon:V,lang:k,children:q})]})},We=s.div`
  position: relative;
  display: flex;
  flex-direction: column;
  gap: ${n.gap["gap-1"]};
...
`,se=({children:e,description:a,variant:r="default",placement:i="bottom-right",offset:o=40,onClose:d,showLeadingIcon:m=!0,showTrailingIcon:p=!0,showDivider:$=!1,className:f="",autoClose:q=!1,autoCloseDelay:V=3e3,index:j=0,disablePositioning:S=!1,lang:x,...v})=>{const[L,T]=c.useState(!1),[R,w]=c.useState(!1),k=typeof j=="number"?j:_;c.useEffect(()=>(_+=1,()=>{_=Math.max(0,_-1)}),[]),c.useEffect(()=>{if(T(!0),q){const y=setTimeout(()=>{w(!0)},V);return()=>clearTimeout(y)}},[q,V]);const I=()=>{w(!0),setTimeout(()=>{d==null||d()},500)},h=()=>{if(!m)return null;switch(r){case"positive":return t.jsx(X,{width:20,height:20,color:"currentColor"});case"negative":return t.jsx(U,{width:20,height:20,color:"currentColor"});case"cautionary":return t.jsx(ge,{width:20,height:20,color:"currentColor"});case"default":default:return t.jsx(fe,{width:20,height:20,color:"currentColor"})}},H=()=>p?t.jsx(ze,{onClick:I,children:t.jsx(he,{width:16,height:16,color:"currentColor"})}):null;return t.jsxs(Ke,{$variant:r,$placement:i,$offset:o,$isVisible:L,$isExiting:R,$index:k,$disablePositioning:S,className:f,...Object.fromEntries(Object.entries(v).filter(([y])=>!["variant","placement","offset"].includes(y))),children:[m&&t.jsx(Je,{$variant:r,children:t.jsx(ee,{children:h()})}),t.jsxs(Qe,{lang:x,children:[t.jsx("div",{children:e}),a&&t.jsx("div",{children:a})]}),$&&t.jsx(Ze,{$variant:r}),p&&t.jsx(ee,{children:H()})]})},Xe=16,Ue=80;let _=0;const Ke=s.div`
  ...
  ${({$disablePositioning:e,$index:a=0,$placement:r,$offset:i})=>!e&&F`
      ...
      /* placement에 따른 위치 설정 */
      ${()=>{const o=i+a*(Ue+Xe);switch(r){case"top-left":return F`
              top: ${o}px;
              left: ${i}px;
