import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{c as a}from"./styled-components.browser.esm-f0aNwSj6.js";import{c as r}from"./color-m2U5piog.js";import{r as h}from"./radius-DaoU83SK.js";import{s as c}from"./spacing-tE1IiUFl.js";import{t as n}from"./textColor-G8dwupNW.js";import{u as b}from"./LNB-DeTNdut1.js";import{t as v}from"./typography-CHdGJV44.js";const x=({value:e,selected:u=!1,disabled:o=!1,leadingIcon:i,iconOnly:d,onClick:p,className:m,lang:s="ko",style:g})=>{const{iconOnly:f}=b(),l=d??f,y=o?n.light["fg-neutral-disable"]:n.light["fg-neutral-primary"];return t.jsxs(k,{type:"button",onClick:o?void 0:p,$selected:u,$disabled:o,$iconOnly:l,className:m,lang:s,style:g,children:[i&&t.jsx($,{children:t.jsx(i,{width:20,height:20,color:y})}),!l&&t.jsx(q,{lang:s,children:e})]})},k=a.button`
  width: 100%;
  height: 36px;
  display: flex;
  align-items: center;
