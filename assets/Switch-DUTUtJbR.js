import{j as m}from"./jsx-runtime-D_zvdyIk.js";import{r as $,R as E}from"./iframe-BNYJyn6Q.js";import{d as c}from"./styled-components.browser.esm-5GbLlbaO.js";import{s as a}from"./spacing-tE1IiUFl.js";import{r as d}from"./radius-DaoU83SK.js";import{c as r}from"./color-CiwAFuFb.js";import{t as T}from"./textColor-DLZeZODc.js";import"./brandColor-OQPP65_V.js";import"./negativeColor-DPOOrHeE.js";import"./cautioniaryColor-DrCmYiBi.js";import"./borderColor-C_RHITEf.js";import"./layerColor-7aOJUZki.js";const g=({size:t="medium",disabled:e=!1,active:n=!1,onChange:o,onClick:s,onFocus:i,onBlur:f,className:v="",style:h,lang:I,...x})=>{const[l,u]=$.useState(n);E.useEffect(()=>{u(n)},[n]);const w=y=>{if(!e){const p=!l;u(p),o==null||o(p),s==null||s(y)}};return m.jsx(b,{$size:t,$disabled:e,$active:l,disabled:e,onClick:w,onFocus:i,onBlur:f,className:`switch ${v}`,style:h,...x,children:m.jsx(R,{$size:t,$disabled:e,$active:l})})},b=c.button`
  position: relative;
  border: none;
  outline: none;
  ...
  &:focus-visible {
    box-shadow: 0 0 0 2px ${r.gray[300]};
  }
`,R=c.div`
  position: absolute;
  border-radius: ${d["rounded-full"]};
  ...
  ${({$active:t,$size:e})=>{const n=e==="small"?16:e==="large"?24:20,o=parseInt(e==="large"?a.gap["gap-1"]:a.gap["gap-0.5"]),i=n*2+o*2-n-o*2;return`
