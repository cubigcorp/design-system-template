import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{S as u,O as C}from"./SolidButton-BApmGIO5.js";import{r as h}from"./iframe-Diu4OQ1h.js";import{r as G}from"./index-BCNg7JgI.js";import{c as m,p as J}from"./styled-components.browser.esm-DZloA45Z.js";import{c as y}from"./color-BUCiRq0z.js";import{r as K}from"./radius-DaoU83SK.js";import{s as g}from"./spacing-tE1IiUFl.js";import{t as W}from"./typography-CHdGJV44.js";import"./borderColor-Bua6bgaN.js";import"./brandColor-C6bU0fYs.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./negativeColor-PFzGnuZM.js";import"./textColor-mWadn7SX.js";import"./types-JZURDx2G.js";import"./preload-helper-eJNa_G2e.js";import"./index-Bpka59JO.js";import"./lineHeight-aJXO3HIm.js";const Q=J`
  from {
    opacity: 0;
  }
  to {
...
`,p=({children:n,text:x,description:f,content:T,contentWidth:H=224,contentHeight:q=126,placement:b="bottom-center",offset:l=4,className:M,defaultVisible:S=!1})=>{const[V,B]=h.useState(S),[P,E]=h.useState({top:0,left:0}),[F,$]=h.useState(!1),[A,a]=h.useState("top"),k=h.useRef(null),w=h.useRef(null),N=()=>{if(!k.current||!w.current)return;const e=k.current.getBoundingClientRect(),o=w.current.getBoundingClientRect(),c=8;let r=0,s=0;switch(b){case"top-left":r=e.top-o.height-l-c,s=e.left,a("bottom");break;case"top-center":r=e.top-o.height-l-c,s=e.left+(e.width-o.width)/2,a("bottom");break;case"top-right":r=e.top-o.height-l-c,s=e.right-o.width,a("bottom");break;case"bottom-left":r=e.bottom+l+c,s=e.left,a("top");break;case"bottom-center":r=e.bottom+l+c,s=e.left+(e.width-o.width)/2,a("top");break;case"bottom-right":r=e.bottom+l+c,s=e.right-o.width,a("top");break;case"left-top":r=e.top,s=e.left-o.width-l-c,a("right");break;case"left-center":r=e.top+(e.height-o.height)/2,s=e.left-o.width-l-c,a("right");break;case"left-bottom":r=e.bottom-o.height,s=e.left-o.width-l-c,a("right");break;case"right-top":r=e.top,s=e.right+l+c,a("left");break;case"right-center":r=e.top+(e.height-o.height)/2,s=e.right+l+c,a("left");break;case"right-bottom":r=e.bottom-o.height,s=e.right+l+c,a("left");break;default:r=e.bottom+l+c,s=e.left+(e.width-o.width)/2,a("top")}E({top:r,left:s}),$(!0)};h.useLayoutEffect(()=>{V&&N()},[V,b,l]);const _=()=>{B(!0)},X=()=>{S||(B(!1),$(!1))},Y=()=>{switch(b){case"top-left":case"bottom-left":return"24px";case"top-right":case"bottom-right":return"calc(100% - 24px)";default:return"50%"}},Z=()=>{switch(b){case"left-top":case"right-top":return"24px";case"left-bottom":case"right-bottom":return"calc(100% - 24px)";default:return"50%"}};return t.jsxs(U,{ref:k,onMouseEnter:_,onMouseLeave:X,className:M,children:[n,V&&G.createPortal(t.jsxs(tt,{ref:w,style:{top:P.top,left:P.left,width:T?H:void 0,visibility:F?"visible":"hidden"},children:[t.jsx(lt,{$position:A,$left:Y(),$top:Z()}),T&&t.jsx(et,{style:{height:q},children:T}),(x||f)&&t.jsxs(nt,{children:[x&&t.jsx(ot,{children:x}),f&&t.jsx(it,{children:f})]})]}),document.body)]})},U=m.div`
  position: relative;
`,tt=m.div`
  position: fixed;
  display: flex;
...
}`,...(R=(z=v.parameters)==null?void 0:z.docs)==null?void 0:R.source}}};var I,L,O;j.parameters={...j.parameters,docs:{...(I=j.parameters)==null?void 0:I.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(O=(L=j.parameters)==null?void 0:L.docs)==null?void 0:O.source}}};const Ct=["Playground","Overview"];export{j as Overview,v as Playground,Ct as __namedExportsOrder,wt as default};
