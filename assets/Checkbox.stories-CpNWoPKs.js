import{j as e}from"./jsx-runtime-BZyYZB_P.js";import{r as V}from"./iframe-Ck2s8rWu.js";import{d as W}from"./styled-components.browser.esm-Ciw-Jg2d.js";import{c}from"./color-BKBaEAUu.js";import{t as h}from"./textColor-C1-D1tBN.js";import{b as g}from"./borderColor-C94_pvKu.js";import{r as q}from"./radius-DaoU83SK.js";import{s as N}from"./spacing-tE1IiUFl.js";import{I as _}from"./IconSearch-DZSG7u3u.js";const n=({variant:a="secondary",state:r="unchecked",disabled:s=!1,onChange:t,className:m="",...y})=>{const u=()=>{if(s)return;const l=r!=="checked";t==null||t(l)},f=()=>r==="checked"?e.jsx(_,{width:16,height:16,color:"currentColor"}):null;return e.jsx(E,{$variant:a,$state:r,$disabled:s,onClick:u,className:m,...y,children:f()})},E=W.div`
  width: 16px;
  height: 16px;
