import{j as N}from"./jsx-runtime-D_zvdyIk.js";import{R as i}from"./iframe-D0DrdOha.js";import{l as o,d as x}from"./styled-components.browser.esm-DPRVC5T4.js";import{c as l}from"./color-CiwAFuFb.js";import{r as M}from"./radius-DaoU83SK.js";import{s as c}from"./spacing-tE1IiUFl.js";import{t as a}from"./textColor-DLZeZODc.js";import{t as q}from"./typography-CHdGJV44.js";const u=i.forwardRef(({children:n,onClick:t,active:s=!1,disabled:e=!1,leadingIcon:d,trailingIcon:p,className:f,...m},g)=>{const[h,r]=i.useState("default"),y=()=>{e||r("hovered")},v=()=>{e||r("default")},$=()=>{e||r("pressed")},R=()=>{e||r("hovered")},b=()=>{e||r("focused")},k=()=>{e||r("default")},w=()=>{!e&&t&&t()};return N.jsxs(B,{ref:g,className:f,$state:h,$active:s,$disabled:e,onMouseEnter:y,onMouseLeave:v,onMouseDown:$,onMouseUp:R,onFocus:b,onBlur:k,onClick:w,disabled:e,...m,children:[d,n,p]})});u.displayName="BreadcrumbItem";const B=x.button`
  display: inline-flex;
  align-items: center;
  gap: ${c.gap["gap-1"]};
