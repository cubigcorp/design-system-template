import{j as d}from"./jsx-runtime-DlIY-_KO.js";import{d as i}from"./styled-components.browser.esm-BaVA2u1f.js";import{c as r}from"./color-DlZ4f652.js";import{b as a}from"./borderColor-BrY1a26q.js";import{r as l}from"./radius-DaoU83SK.js";const n=({state:e="unchecked",disabled:o=!1,onChange:t,className:s="",style:c,...u})=>{const p=()=>{if(o)return;const m=e!=="checked";t==null||t(m)};return d.jsx(f,{$state:e,$disabled:o,onClick:p,className:s,style:c,...u,children:e==="checked"&&d.jsx(b,{})})},f=i.div`
  width: 16px;
  height: 16px;
