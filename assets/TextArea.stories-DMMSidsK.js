import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./iframe-skmiukBS.js";import{c as b}from"./styled-components.browser.esm-1f8qeTbm.js";import{b as h}from"./borderColor-CzkI5wcR.js";import{c as g}from"./color-m2U5piog.js";import{r as ye}from"./radius-DaoU83SK.js";import{s as d}from"./spacing-tE1IiUFl.js";import{t as o}from"./textColor-G8dwupNW.js";import{t as _}from"./typography-CHdGJV44.js";import{L as me}from"./Label-DtMDi8sn.js";import{D as ve}from"./Description-D-E_QL1s.js";import"./preload-helper-eJNa_G2e.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./lineHeight-aJXO3HIm.js";import"./negativeColor-fk0-w6JK.js";import"./IconCircleCheck-BBUUqRs3.js";const l=r.forwardRef(({label:t,labelType:P="default",optionalText:G,description:$,descriptionLeadingIcon:J=!1,status:c="default",disabled:i=!1,active:K=!1,focused:Q=!1,placeholder:U,value:C,showCharacterCounter:X=!1,maxCount:s,maxHeight:w=232,onChange:j,onFocus:T,onBlur:D,className:Y="",lang:Z,...ee},ne)=>{const[A,q]=r.useState(Q),[te,E]=r.useState(K),[le,ae]=r.useState(C),L=r.useRef(null),p=Z;r.useImperativeHandle(ne,()=>L.current);const S=C!==void 0?C:le,u=s?(S||"").slice(0,s):S||"",se=u.length,re=()=>{const a=L.current;if(a){a.style.height="auto";const x=Math.min(a.scrollHeight,w);a.style.height=`${x}px`}};r.useEffect(()=>{re()},[u,w]);const ie=a=>{q(!0),E(!0),T==null||T(a)},oe=a=>{q(!1),E(!1),D==null||D(a)},de=a=>{const x=a.target.value;s&&x.length>s||(ae(x),j==null||j(a))},ce=()=>i?o.light["fg-neutral-disable"]:te||u?o.light["fg-neutral-primary"]:o.light["fg-neutral-assistive"],pe=()=>i?o.light["fg-neutral-disable"]:o.light["fg-neutral-alternative"],ue=()=>c==="negative"?h.light["color-border-negative"]:i?h.light["color-border-primary"]:A?h.light["color-border-focused"]:h.light["color-border-primary"],xe=()=>c==="negative"||A?"1.8px":"1px",he=()=>i?g.gray[50]:g.common[100];return e.jsxs(fe,{className:Y,children:[t&&e.jsx(me,{type:P,optionalText:G,lang:p,children:t}),e.jsxs(ge,{$disabled:i,$focused:A,$borderColor:ue(),$borderWidth:xe(),$backgroundColor:he(),children:[e.jsx(be,{ref:L,placeholder:U,value:u,disabled:i,maxLength:s,onChange:de,onFocus:ie,onBlur:oe,$textColor:ce(),$maxHeight:w,lang:p,...ee}),X&&s&&e.jsxs(Ce,{$color:pe(),lang:p,children:[se,"/",s]})]}),$&&e.jsx(ve,{status:c==="negative"?"negative":void 0,leadingIcon:c==="negative"?!0:J,lang:p,children:$})]})}),fe=b.div`
  display: flex;
...
}`,...(B=(z=f.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};const Ne=["Playground","Overview","AllStates","ContentOptions"];export{v as AllStates,f as ContentOptions,m as Overview,y as Playground,Ne as __namedExportsOrder,Oe as default};
