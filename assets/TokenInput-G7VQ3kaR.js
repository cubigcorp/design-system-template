import{j as i}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./iframe-BNYJyn6Q.js";import{d as c}from"./styled-components.browser.esm-5GbLlbaO.js";import{S as W}from"./icon_close_outline_16-BWBdWELy.js";import{C as _}from"./Chip-zmFavlvj.js";import{c as p}from"./color-CiwAFuFb.js";import{t as x}from"./textColor-DLZeZODc.js";import"./brandColor-OQPP65_V.js";import"./negativeColor-DPOOrHeE.js";import"./cautioniaryColor-DrCmYiBi.js";import{b as $}from"./borderColor-C_RHITEf.js";import"./layerColor-7aOJUZki.js";import{t as v}from"./typography-hbgufnaT.js";import{r as O}from"./radius-DaoU83SK.js";import{s as l}from"./spacing-tE1IiUFl.js";const C=({size:t="medium",disabled:n=!1,placeholder:R="입력 후 Enter를 눌러주세요.",value:g=[],onChange:a,onFocus:f,onBlur:h,className:q="",style:H,lang:y="ko",lineMode:b="multi",...j})=>{const[w,k]=u.useState(!1),[m,T]=u.useState(""),[s,d]=u.useState(g),[L,I]=u.useState(!1),E=u.useRef(null);u.useEffect(()=>{d(g)},[g]);const V=e=>{T(e.target.value)},M=e=>{k(!0),f==null||f(e)},z=e=>{k(!1),h==null||h(e)},F=()=>{I(!0)},N=()=>{I(!1)},D=e=>{if(e.key==="Enter"&&!L&&m.trim()){e.preventDefault();const r=m.trim();if(!s.includes(r)){const o=[...s,r];d(o),a==null||a(o)}T("")}else if(e.key==="Backspace"&&!m&&s.length>0){e.preventDefault();const r=s.slice(0,-1);d(r),a==null||a(r)}},P=e=>{const r=s.filter(o=>o!==e);d(r),a==null||a(r)},S=()=>{switch(t){case"small":return"x-small";case"large":return"small";default:return"x-small"}},A=()=>{switch(S()){case"x-small":return 24;case"small":return 32;case"medium":return 36;default:return 24}},K=()=>{const e=A(),r=4,o=8;return b==="single"?e+o:e*3+r*2+o};return i.jsx(B,{className:`tokeninput-container ${q}`,style:H,...j,children:i.jsx(G,{$size:t,$disabled:n,$focused:w,$hasTokens:s.length>0,lang:y,onClick:()=>{var e;return(e=E.current)==null?void 0:e.focus()},children:i.jsxs(J,{$maxHeight:K(),$lineMode:b,$size:t,children:[s.map((e,r)=>i.jsx(Q,{onClick:o=>{n||(o.stopPropagation(),P(e))},children:i.jsx(_,{type:"solid",size:S(),disabled:n,trailingIcon:i.jsx(W,{color:"currentColor"}),children:e})},`${e}-${r}`)),i.jsx(U,{ref:E,$size:t,$disabled:n,$focused:w,$hasTokens:s.length>0,lang:y,value:m,placeholder:s.length===0?R:"",disabled:n,onChange:V,onFocus:M,onBlur:z,onKeyDown:D,onCompositionStart:F,onCompositionEnd:N})]})})})},B=c.div`
  position: relative;
  display: flex;
...
`,U=c.input`
  ...
  ${({$disabled:t})=>t?`
        color: ${x.light["fg-neutral-disable"]};
        cursor: not-allowed;
      `:`
