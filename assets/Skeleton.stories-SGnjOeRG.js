import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{s as E,c as M,p as W}from"./styled-components.browser.esm-DZloA45Z.js";import"./iframe-Diu4OQ1h.js";import"./preload-helper-eJNa_G2e.js";const d="rgba(238, 239, 241, 1)",i="rgba(238, 239, 241, 0.4)",F=W`
  0% {
    background: linear-gradient(106deg, ${d} 0%, ${i} 50%, ${i} 100%);
  }
  33.33% {
    background: linear-gradient(106deg, ${i} 0%, ${d} 50%, ${i} 100%);
  }
  66.66% {
    background: linear-gradient(106deg, ${i} 0%, ${i} 50%, ${d} 100%);
  }
  100% {
    background: linear-gradient(106deg, ${d} 0%, ${i} 50%, ${i} 100%);
  }
`,L=s=>{switch(s){case"rect":return{width:130,height:80};case"image":return{width:40,height:40};case"text":return{width:180,height:16}}},_=(s,a)=>{switch(s){case"rect":return"8px";case"image":return a==="large"?"9999px":"8px";case"text":return a==="large"?"9999px":"4px"}},n=({variant:s="rect",size:a="medium",width:l,height:r,className:y})=>{const p=L(s);return e.jsx(O,{$variant:s,$size:a,$width:l??p.width,$height:r??p.height,className:y})},O=M.div`
  ${({$variant:s,$size:a,$width:l,$height:r})=>{const y=typeof l=="number"?`${l}px`:l,p=typeof r=="number"?`${r}px`:r,q=_(s,a);return E`
      width: ${y};
      height: ${p};
      border-radius: ${q};
      background: linear-gradient(106deg, ${d} 0%, ${i} 50%, ${i} 100%);
...
}`,...(f=(u=o.parameters)==null?void 0:u.docs)==null?void 0:f.source}}};var j,b,S;c.parameters={...c.parameters,docs:{...(j=c.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    variant: 'rect',
    width: 130,
    height: 80
  }
}`,...(S=(b=c.parameters)==null?void 0:b.docs)==null?void 0:S.source}}};var w,z,k;x.parameters={...x.parameters,docs:{...(w=x.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    variant: 'image',
    size: 'medium'
  }
}`,...(k=(z=x.parameters)==null?void 0:z.docs)==null?void 0:k.source}}};var T,$,I;g.parameters={...g.parameters,docs:{...(T=g.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    variant: 'image',
    size: 'large'
  }
}`,...(I=($=g.parameters)==null?void 0:$.docs)==null?void 0:I.source}}};var C,B,R;m.parameters={...m.parameters,docs:{...(C=m.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    variant: 'text',
    size: 'medium'
  }
}`,...(R=(B=m.parameters)==null?void 0:B.docs)==null?void 0:R.source}}};var A,D,V;h.parameters={...h.parameters,docs:{...(A=h.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    variant: 'text',
    size: 'large'
  }
}`,...(V=(D=h.parameters)==null?void 0:D.docs)==null?void 0:V.source}}};const K=["Overview","Rect","ImageMedium","ImageLarge","TextMedium","TextLarge"];export{g as ImageLarge,x as ImageMedium,o as Overview,c as Rect,h as TextLarge,m as TextMedium,K as __namedExportsOrder,J as default};
