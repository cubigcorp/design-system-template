import{j as c}from"./jsx-runtime-xCA2v9vi.js";import{r as $,R as E}from"./iframe-OZy89DUD.js";import{d as m}from"./styled-components.browser.esm-DOVniiux.js";import{s as a}from"./spacing-tE1IiUFl.js";import{r as d}from"./radius-DaoU83SK.js";import{c as n}from"./color-DlZ4f652.js";import{t as T}from"./textColor-DVi7834n.js";const g=({size:t="medium",disabled:e=!1,active:r=!1,onChange:o,onClick:s,onFocus:i,onBlur:f,className:v="",style:h,lang:I,...x})=>{const[l,u]=$.useState(r);E.useEffect(()=>{u(r)},[r]);const w=y=>{if(!e){const p=!l;u(p),o==null||o(p),s==null||s(y)}};return c.jsx(b,{$size:t,$disabled:e,$active:l,disabled:e,onClick:w,onFocus:i,onBlur:f,className:`switch ${v}`,style:h,...x,children:c.jsx(R,{$size:t,$disabled:e,$active:l})})},b=m.button`
  position: relative;
  border: none;
  outline: none;
