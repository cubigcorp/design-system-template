import{j as t}from"./jsx-runtime-DORK9biX.js";import{r as c}from"./iframe-Drh7vK1U.js";import{d as s,l as H,m as J}from"./styled-components.browser.esm-Cr-any12.js";import{c as o}from"./color-DlZ4f652.js";import{t as i,b as u}from"./borderColor-7dRAAa5F.js";import{p as M,n as O}from"./negativeColor-DFTQtxpe.js";import{t as D,a as T}from"./typography-BLDI0FEN.js";import{r as C}from"./radius-DaoU83SK.js";import{s as a}from"./spacing-tE1IiUFl.js";import{a as _,b as A,c as le,d as oe,e as K,f as Q,I as se,g as de,h as ce,i as ue}from"./IconClose-CNP3TcGH.js";import{s as Z}from"./shadow-DVq_1U2q.js";const N=({children:e,type:r="default",className:n="",...l})=>{const f=()=>{switch(r){case"required":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(ge,{children:"*"})]});case"optional":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(me,{children:"(선택)"})]});default:return t.jsx("span",{children:e})}};return t.jsx(pe,{$type:r,className:n,...l,children:f()})},pe=s.label`
  ${D.body2}
  height: 20px;
  display: flex;
  align-items: center;
