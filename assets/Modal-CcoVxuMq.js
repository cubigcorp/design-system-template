import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{d as c,l as P,m as z}from"./styled-components.browser.esm-LFH3Vo6z.js";import{L as ve,D as he}from"./Description-DO1GCdwH.js";import{r as s,R as G}from"./iframe-BW59HvWr.js";import{r as re}from"./index-n2NQl2Z2.js";import{f as ne,g as oe,h as ye,i as be,a as xe,I as we,j as le}from"./IconSearch-D4pbJy3T.js";import"./IconCheck-CKtc9n1_.js";import{M as ie,C as se,a as $e}from"./MultiSelect-Ci8tKadh.js";import{c as u}from"./color-CiwAFuFb.js";import{t as T}from"./textColor-DLZeZODc.js";import"./brandColor-OQPP65_V.js";import"./negativeColor-DPOOrHeE.js";import"./cautioniaryColor-DrCmYiBi.js";import{b as V}from"./borderColor-C_RHITEf.js";import{l as ue}from"./layerColor-7aOJUZki.js";import{t as D,a as Te}from"./typography-RVdj8V17.js";import{r as N}from"./radius-DaoU83SK.js";import{s as o}from"./spacing-tE1IiUFl.js";import{s as de}from"./shadow-DVq_1U2q.js";const U=({size:e="medium",disabled:t=!1,active:r=!1,focused:n=!1,placeholder:d="선택해주세요.",value:f,options:g=[],onChange:y,onFocus:$,onBlur:b,className:C="",style:i,lang:x="ko",showCheckIcon:w=!0,...h})=>{const[m,S]=s.useState(!1),[v,k]=s.useState(r),[E,R]=s.useState(n),[j,q]=s.useState({top:0,left:0,width:0}),I=s.useRef(null),M=s.useRef(null);s.useEffect(()=>{const p=H=>{const F=H.target;M.current&&M.current.contains(F)||I.current&&!I.current.contains(F)&&(S(!1),R(!1))};return document.addEventListener("mousedown",p),()=>{document.removeEventListener("mousedown",p)}},[]),s.useEffect(()=>{k(r)},[r]),s.useEffect(()=>{R(n)},[n]),s.useEffect(()=>{if(m&&I.current){const p=()=>{if(I.current){const H=I.current.getBoundingClientRect();q({top:H.bottom+window.scrollY,left:H.left+window.scrollX,width:H.width})}};return p(),window.addEventListener("scroll",p,!0),window.addEventListener("resize",p),()=>{window.removeEventListener("scroll",p,!0),window.removeEventListener("resize",p)}}},[m]);const A=g.find(p=>p.value===f),O=()=>{t||(S(!m),m?(R(!1),k(!1),b==null||b({})):(R(!0),k(!0),$==null||$({})))},_=p=>{y==null||y(p.value),S(!1),R(!1),b==null||b({})},B=()=>t?T.light["fg-neutral-alternative"]:T.light["fg-neutral-primary"];return a.jsxs(Ee,{ref:I,className:`selector-container ${C}`,style:i,...h,children:[a.jsxs(Ce,{$size:e,$disabled:t,$active:v,$focused:E,lang:x,onClick:O,type:"button","data-active":v?"true":"false",children:[a.jsx(je,{children:A?A.label:d}),a.jsx(Se,{size:e,children:m?a.jsx(ne,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:B()}):a.jsx(oe,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:B()})})]}),m&&re.createPortal(a.jsx(Ie,{ref:M,onMouseDown:p=>p.stopPropagation(),onMouseDownCapture:p=>p.stopPropagation(),onClick:p=>p.stopPropagation(),"data-portal-menu":!0,$top:j.top,$left:j.left,$width:j.width,children:a.jsx(ie,{showCheckIcon:w,children:g.map(p=>a.jsx(se,{text:p.label,description:p.description,leadingContent:p.leadingContent,active:p.value===f,onClick:H=>{H.stopPropagation(),_(p)}},p.value))})}),document.body)]})},Ee=c.div`
  position: relative;
  display: flex;
...
`,Le=G.forwardRef((e,t)=>a.jsx(Me,{ref:t,...e})),Pe=c.div`
  position: absolute;
  right: ${({size:e})=>e==="large"?o.gap["gap-2.5"]:o.gap["gap-2"]};
  top: 50%;
  transform: translateY(-50%);
...
`,J=({children:e,description:t,variant:r="default",placement:n="bottom-right",offset:d=40,onClose:f,showLeadingIcon:g=!0,showTrailingIcon:y=!0,showDivider:$=!1,className:b="",autoClose:C=!1,autoCloseDelay:i=3e3,index:x=0,disablePositioning:w=!1,lang:h,...m})=>{const[S,v]=s.useState(!1),[k,E]=s.useState(!1),R=typeof x=="number"?x:Y;s.useEffect(()=>(Y+=1,()=>{Y=Math.max(0,Y-1)}),[]),s.useEffect(()=>{if(v(!0),C){const M=setTimeout(()=>{E(!0)},i);return()=>clearTimeout(M)}},[C,i]);const j=()=>{E(!0),setTimeout(()=>{f==null||f()},500)},q=()=>{if(!g)return null;switch(r){case"positive":return a.jsx(we,{width:20,height:20,color:"currentColor"});case"negative":return a.jsx(xe,{width:20,height:20,color:"currentColor"});case"cautionary":return a.jsx(be,{width:20,height:20,color:"currentColor"});case"default":default:return a.jsx(ye,{width:20,height:20,color:"currentColor"})}},I=()=>y?a.jsx(ze,{onClick:j,children:a.jsx(le,{width:16,height:16,color:"currentColor"})}):null;return a.jsxs(Fe,{$variant:r,$placement:n,$offset:d,$isVisible:S,$isExiting:k,$index:R,$disablePositioning:w,className:b,...Object.fromEntries(Object.entries(m).filter(([M])=>!["variant","placement","offset"].includes(M))),children:[g&&a.jsx(Ye,{$variant:r,children:a.jsx(ae,{children:q()})}),a.jsxs(We,{lang:h,children:[a.jsx("div",{children:e}),t&&a.jsx("div",{children:t})]}),$&&a.jsx(Xe,{$variant:r}),y&&a.jsx(ae,{children:I()})]})},Ae=16,_e=80;let Y=0;const Fe=c.div`
  display: flex;
  align-items: center;
