import{j as t}from"./jsx-runtime-B6jsIko1.js";import{r as v}from"./iframe-CU6_g4nP.js";import{d as s}from"./styled-components.browser.esm-Bpw6-ZWk.js";import{c as b}from"./color-CMFzNX_O.js";import{t as r,b as u}from"./borderColor-C1c8KEhD.js";import{t as R,a as x}from"./typography-he8MZv4l.js";import{s as l}from"./spacing-tE1IiUFl.js";import{p as T,n as k}from"./negativeColor-vAhOVlFC.js";import{r as A}from"./radius-DaoU83SK.js";import{a as H,b as N,c as B,d as G}from"./IconVisibilityOn-B3GyUAg9.js";const L=({children:e,type:n="default",className:i="",...a})=>{const c=()=>{switch(n){case"required":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(J,{children:"*"})]});case"optional":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(K,{children:"(선택)"})]});default:return t.jsx("span",{children:e})}};return t.jsx(Y,{$type:n,className:i,...a,children:c()})},Y=s.label`
  ${R.body2}
  height: 20px;
  display: flex;
  align-items: center;
