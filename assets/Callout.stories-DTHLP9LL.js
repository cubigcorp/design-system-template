import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{R as U}from"./iframe-Diu4OQ1h.js";import{c as s}from"./styled-components.browser.esm-DZloA45Z.js";import{c as t}from"./color-BUCiRq0z.js";import{n as u,p as g}from"./negativeColor-PFzGnuZM.js";import{r as _}from"./radius-DaoU83SK.js";import{s as l}from"./spacing-tE1IiUFl.js";import{t as i}from"./textColor-mWadn7SX.js";import{t as q}from"./typography-CHdGJV44.js";import{S as B}from"./icon_chevron-right_outline_20-1BpR0uI5.js";import{S as x,a as E,b as L,c as M,d as P}from"./icon_warning_fill_16-Lz-EadT8.js";import"./preload-helper-eJNa_G2e.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./lineHeight-aJXO3HIm.js";const r=U.forwardRef(({variant:n="primary",size:y="medium",title:O,description:f,leadingIcon:v=!0,trailingIcon:V=!1,onTrailingIconClick:W,className:z,...R},A)=>{const N=()=>{if(!v)return null;switch(n){case"positive":return e.jsx(P,{});case"negative":return e.jsx(M,{});case"cautionary":return e.jsx(L,{});case"info":return e.jsx(x,{});case"brand":return e.jsx(E,{});default:return e.jsx(x,{})}};return e.jsxs(H,{ref:A,className:z,$variant:n,$size:y,...R,children:[v&&e.jsx(G,{$variant:n,$size:y,children:N()}),e.jsxs(J,{children:[e.jsx(K,{$variant:n,children:O}),f&&e.jsx(Q,{$variant:n,children:f})]}),V&&e.jsx(X,{onClick:W,$variant:n,children:e.jsx(B,{})})]})});r.displayName="Callout";const H=s.div`
  display: flex;
