import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as f,R as N}from"./iframe-skmiukBS.js";import{c as R}from"./styled-components.browser.esm-1f8qeTbm.js";import{r as q}from"./radius-DaoU83SK.js";import{s as i}from"./spacing-tE1IiUFl.js";import{c as o}from"./color-m2U5piog.js";import{t as P}from"./textColor-G8dwupNW.js";import"./preload-helper-eJNa_G2e.js";const c=({size:e="medium",disabled:a=!1,active:l=!1,activeColor:r,onChange:s,onClick:d,onFocus:F,onBlur:H,className:W="",style:D,lang:K,...L})=>{const[v,b]=f.useState(l);N.useEffect(()=>{b(l)},[l]);const C=A=>{if(!a){const x=!v;b(x),s==null||s(x),d==null||d(A)}};return t.jsx(V,{$size:e,$disabled:a,$active:v,$activeColor:r,disabled:a,onClick:C,onFocus:F,onBlur:H,className:`switch ${W}`,style:D,...L,children:t.jsx(_,{$size:e,$disabled:a,$active:v})})},V=R.button`
  position: relative;
  border: none;
  outline: none;
