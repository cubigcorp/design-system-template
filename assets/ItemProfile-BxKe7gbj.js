import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{d as n}from"./styled-components.browser.esm-kr1dGAPk.js";import{c as t}from"./color-CiwAFuFb.js";import{r as f}from"./radius-DaoU83SK.js";import{s}from"./spacing-tE1IiUFl.js";import{t as l}from"./textColor-DLZeZODc.js";import{A as g}from"./Avatar-BS50BBU7.js";import{u as y}from"./LNB-Cwp352qU.js";import{t as h}from"./typography-CHdGJV44.js";const v=({name:r,avatarSrc:m,avatarType:u="custom",onClick:p,className:c,lang:a="ko",style:d,trailingIcon:i})=>{const{iconOnly:o}=y();return e.jsxs(x,{type:"button",onClick:p,className:c,lang:a,style:d,$iconOnly:o,children:[e.jsx(g,{type:u,size:"x-small",src:m,value:r}),!o&&e.jsxs(e.Fragment,{children:[e.jsx(b,{lang:a,children:r}),i&&e.jsx(w,{children:e.jsx(i,{width:20,height:20,color:l.light["fg-neutral-primary"]})})]})]})},x=n.button`
  width: 100%;
  height: 40px;
  display: flex;
  align-items: center;
