import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{a as r,T as s,t as n}from"./ToastSystem-DQfd9NUk.js";import"./iframe-D0DrdOha.js";import"./preload-helper-eJNa_G2e.js";import"./styled-components.browser.esm-DPRVC5T4.js";import"./color-CiwAFuFb.js";import"./radius-DaoU83SK.js";import"./shadow-DVq_1U2q.js";import"./spacing-tE1IiUFl.js";import"./textColor-DLZeZODc.js";import"./IconCircleCheck-BBUUqRs3.js";import"./typography-CHdGJV44.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./lineHeight-aJXO3HIm.js";const yt={title:"Components/Toast",component:r,parameters:{layout:"fullscreen",docs:{description:{component:"Toast 컴포넌트는 사용자에게 알림을 표시하는 데 사용됩니다."}}},tags:["autodocs"],argTypes:{variant:{control:{type:"select"},options:["default","positive","negative","cautionary"]},placement:{control:{type:"select"},options:["top-left","top-center","top-right","bottom-left","bottom-center","bottom-right"]},offset:{control:{type:"number"}},showLeadingIcon:{control:{type:"boolean"}},showTrailingIcon:{control:{type:"boolean"}},showDivider:{control:{type:"boolean"}}}},o={render:e=>t.jsx(r,{...e}),args:{children:"기본 토스트 메시지입니다.",variant:"default",placement:"bottom-right"}},a={render:e=>t.jsx(r,{...e}),args:{children:`저장이 완료되었습니다.
변경한 내용이 정상적으로 반영되었어요.`,description:"1 저장 완료, 0 실패",variant:"positive",placement:"bottom-right",showDivider:!0}},i={render:e=>t.jsx(r,{...e}),args:{children:`저장에 실패했습니다.
네트워크 연결을 확인해주세요.`,description:"오류 코드: NET_001",variant:"negative",placement:"bottom-right",showDivider:!0}},p={render:e=>t.jsx(r,{...e}),args:{children:`주의가 필요합니다.
이 작업은 되돌릴 수 없습니다.`,description:"계속하시겠습니까?",variant:"cautionary",placement:"bottom-right",showDivider:!0}},c={render:e=>t.jsx(r,{...e}),args:{children:"아이콘 없는 토스트 메시지입니다.",variant:"default",placement:"bottom-right",showLeadingIcon:!1,showTrailingIcon:!1}},d={render:e=>t.jsx(r,{...e}),args:{children:`정보가 업데이트되었습니다.
새로운 기능을 확인해보세요.`,description:"더 자세한 내용은 설정에서 확인하세요.",variant:"default",placement:"bottom-right",showDivider:!0}},l={render:e=>t.jsx(r,{...e}),args:{children:"왼쪽 상단에 위치한 토스트입니다.",variant:"default",placement:"top-left"}},m={render:e=>t.jsx(r,{...e}),args:{children:"하단 중앙에 위치한 토스트입니다.",variant:"positive",placement:"bottom-center"}},u={render:()=>t.jsx(s,{placement:"bottom-right",maxToasts:3,children:t.jsxs("div",{style:{padding:"40px"},children:[t.jsx("h2",{children:"ToastSystem - Bottom Right"}),t.jsx("p",{children:"아래 버튼을 클릭하여 우측 하단에 토스트를 띄워보세요."}),t.jsxs("div",{style:{display:"flex",gap:"8px",marginTop:"16px"},children:[t.jsx("button",{onClick:()=>n.success("저장 완료!","변경사항이 저장되었습니다."),style:{padding:"8px 16px",cursor:"pointer"},children:"Success Toast"}),t.jsx("button",{onClick:()=>n.error("오류 발생","다시 시도해주세요."),style:{padding:"8px 16px",cursor:"pointer"},children:"Error Toast"}),t.jsx("button",{onClick:()=>n.warning("경고","주의가 필요합니다."),style:{padding:"8px 16px",cursor:"pointer"},children:"Warning Toast"}),t.jsx("button",{onClick:()=>n.info("알림","새로운 업데이트가 있습니다."),style:{padding:"8px 16px",cursor:"pointer"},children:"Info Toast"})]})]})})},x={render:()=>t.jsx(s,{placement:"top-center",maxToasts:3,children:t.jsxs("div",{style:{padding:"40px"},children:[t.jsx("h2",{children:"ToastSystem - Top Center"}),t.jsx("p",{children:"아래 버튼을 클릭하여 상단 중앙에 토스트를 띄워보세요."}),t.jsxs("div",{style:{display:"flex",gap:"8px",marginTop:"16px"},children:[t.jsx("button",{onClick:()=>n.success("저장 완료!","변경사항이 저장되었습니다."),style:{padding:"8px 16px",cursor:"pointer"},children:"Success Toast"}),t.jsx("button",{onClick:()=>n.error("오류 발생","다시 시도해주세요."),style:{padding:"8px 16px",cursor:"pointer"},children:"Error Toast"}),t.jsx("button",{onClick:()=>n.warning("경고","주의가 필요합니다."),style:{padding:"8px 16px",cursor:"pointer"},children:"Warning Toast"}),t.jsx("button",{onClick:()=>n.info("알림","새로운 업데이트가 있습니다."),style:{padding:"8px 16px",cursor:"pointer"},children:"Info Toast"})]})]})})},g={render:()=>t.jsx(s,{placement:"top-left",maxToasts:3,children:t.jsxs("div",{style:{padding:"40px"},children:[t.jsx("h2",{children:"ToastSystem - Top Left"}),t.jsx("p",{children:"아래 버튼을 클릭하여 좌측 상단에 토스트를 띄워보세요."}),t.jsxs("div",{style:{display:"flex",gap:"8px",marginTop:"16px"},children:[t.jsx("button",{onClick:()=>n.success("저장 완료!","변경사항이 저장되었습니다."),style:{padding:"8px 16px",cursor:"pointer"},children:"Success Toast"}),t.jsx("button",{onClick:()=>n.error("오류 발생","다시 시도해주세요."),style:{padding:"8px 16px",cursor:"pointer"},children:"Error Toast"})]})]})})},T={render:()=>t.jsx(s,{placement:"bottom-center",maxToasts:3,children:t.jsxs("div",{style:{padding:"40px"},children:[t.jsx("h2",{children:"ToastSystem - Bottom Center"}),t.jsx("p",{children:"아래 버튼을 클릭하여 하단 중앙에 토스트를 띄워보세요."}),t.jsxs("div",{style:{display:"flex",gap:"8px",marginTop:"16px"},children:[t.jsx("button",{onClick:()=>n.success("저장 완료!","변경사항이 저장되었습니다."),style:{padding:"8px 16px",cursor:"pointer"},children:"Success Toast"}),t.jsx("button",{onClick:()=>n.error("오류 발생","다시 시도해주세요."),style:{padding:"8px 16px",cursor:"pointer"},children:"Error Toast"})]})]})})},h={render:()=>t.jsx(s,{placement:"bottom-right",maxToasts:5,children:t.jsxs("div",{style:{padding:"40px"},children:[t.jsx("h2",{children:"ToastSystem - Multiple Toasts"}),t.jsx("p",{children:"여러 개의 토스트를 연속으로 띄워 스택킹 동작을 확인하세요."}),t.jsx("div",{style:{display:"flex",gap:"8px",marginTop:"16px"},children:t.jsx("button",{onClick:()=>{n.success("첫 번째","토스트 1"),setTimeout(()=>n.info("두 번째","토스트 2"),300),setTimeout(()=>n.warning("세 번째","토스트 3"),600),setTimeout(()=>n.error("네 번째","토스트 4"),900)},style:{padding:"8px 16px",cursor:"pointer"},children:"4개 연속 띄우기"})})]})})};var y,v,b;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
...
}`,...(b=(v=o.parameters)==null?void 0:v.docs)==null?void 0:b.source}}};var f,S,j;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => <Toast {...args} />,
  args: {
...
}`,...($=(Z=T.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};var tt,nt,et;h.parameters={...h.parameters,docs:{...(tt=h.parameters)==null?void 0:tt.docs,source:{originalSource:`{
...
}`,...(et=(nt=h.parameters)==null?void 0:nt.docs)==null?void 0:et.source}}};const vt=["Default","Positive","Negative","Cautionary","WithoutIcons","WithDivider","TopLeft","BottomCenter","ToastSystemBottomRight","ToastSystemTopCenter","ToastSystemTopLeft","ToastSystemBottomCenter","ToastSystemMultipleToasts"];export{m as BottomCenter,p as Cautionary,o as Default,i as Negative,a as Positive,T as ToastSystemBottomCenter,u as ToastSystemBottomRight,h as ToastSystemMultipleToasts,x as ToastSystemTopCenter,g as ToastSystemTopLeft,l as TopLeft,d as WithDivider,c as WithoutIcons,vt as __namedExportsOrder,yt as default};
