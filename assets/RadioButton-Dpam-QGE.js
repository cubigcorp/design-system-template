import{j as i}from"./jsx-runtime-D_zvdyIk.js";import{d}from"./textColor-BxK-JWCE.js";import{c as r}from"./color-CiwAFuFb.js";import"./negativeColor-C6enJIYV.js";import"./cautioniaryColor-DrCmYiBi.js";import{b as a}from"./borderColor-C_RHITEf.js";import"./layerColor-7aOJUZki.js";import{r as l}from"./radius-DaoU83SK.js";const n=({state:e="unchecked",disabled:o=!1,onChange:t,className:s="",style:c,...u})=>{const p=()=>{if(o)return;const m=e!=="checked";t==null||t(m)};return i.jsx(f,{$state:e,$disabled:o,onClick:p,className:s,style:c,...u,children:e==="checked"&&i.jsx(b,{})})},f=d.div`
  width: 16px;
  height: 16px;
