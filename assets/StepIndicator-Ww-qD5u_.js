import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{d as r,t as d,l as s}from"./textColor-BD1R82Cy.js";import{c as o}from"./color-CiwAFuFb.js";import{b as g}from"./borderColor-C_RHITEf.js";import{s as I}from"./spacing-tE1IiUFl.js";import{t as h}from"./typography-BBThIZ7c.js";import{I as w}from"./IconCheck-CKtc9n1_.js";const m=24,f=16,x=({status:e,step:l,label:a,showLabel:c=!1})=>t.jsxs(j,{children:[t.jsx(C,{$status:e,children:e==="Complete"?t.jsx(k,{children:t.jsx(w,{color:"white",width:16,height:16})}):l}),c&&a&&t.jsx(T,{$status:e,children:a})]}),j=r.div`
  display: flex;
...
`;x.__docgenInfo={description:"",methods:[],displayName:"ProgressTracker",props:{status:{required:!0,tsType:{name:"union",raw:'"Inactive" | "Active" | "Complete"',elements:[{name:"literal",value:'"Inactive"'},{name:"literal",value:'"Active"'},{name:"literal",value:'"Complete"'}]},description:""},step:{required:!0,tsType:{name:"number"},description:""},label:{required:!1,tsType:{name:"string"},description:""},showLabel:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const y=({status:e})=>t.jsx(q,{$status:e}),q=r.div`
  ...
  ${({$status:e})=>{switch(e){case"Complete":return s`
        ...
        `}}}
`;y.__docgenInfo={description:"",methods:[],displayName:"StepDivider",props:{status:{required:!0,tsType:{name:"union",raw:'"Inactive" | "Active" | "Complete"',elements:[{name:"literal",value:'"Inactive"'},{name:"literal",value:'"Active"'},{name:"literal",value:'"Complete"'}]},description:""}}};const A=({count:e,currentStep:l,steps:a,showLabel:c=!1,className:v})=>{const $=n=>n<l?"Complete":n===l?"Active":"Inactive",S=()=>{const n=[];for(let i=1;i<=e;i++){const u=$(i),p=a==null?void 0:a[i-1],b=(p==null?void 0:p.label)||"단계";n.push(t.jsxs(N,{children:[t.jsx(x,{status:u,step:i,label:b,showLabel:c}),i<e&&t.jsx(y,{status:u})]},i))}return n};return t.jsx(_,{className:v,children:t.jsx(E,{showLabel:c,children:S()})})},_=r.div`
  display: flex;
  flex-direction: column;
  width: 100%;
`,E=r.div`
