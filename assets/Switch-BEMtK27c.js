import{j as c}from"./jsx-runtime-WsICpuy1.js";import{r as $,R as E}from"./iframe-_vL07Yt-.js";import{d as m}from"./styled-components.browser.esm-BDiU6mDK.js";import{s as a}from"./spacing-tE1IiUFl.js";import{r as d}from"./radius-DaoU83SK.js";import{c as n}from"./color-DqDZjiGS.js";import{t as T}from"./textColor-SSyLf7rE.js";const g=({size:t="medium",disabled:e=!1,active:r=!1,onChange:o,onClick:s,onFocus:i,onBlur:f,className:v="",style:h,lang:I,...x})=>{const[l,u]=$.useState(r);E.useEffect(()=>{u(r)},[r]);const w=y=>{if(!e){const p=!l;u(p),o==null||o(p),s==null||s(y)}};return c.jsx(b,{$size:t,$disabled:e,$active:l,disabled:e,onClick:w,onFocus:i,onBlur:f,className:`switch ${v}`,style:h,...x,children:c.jsx(R,{$size:t,$disabled:e,$active:l})})},b=m.button`
  position: relative;
  border: none;
  outline: none;
