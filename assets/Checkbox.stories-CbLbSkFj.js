import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as V}from"./iframe-D0ynm1mK.js";import{c as W}from"./styled-components.browser.esm-o0t8qbnT.js";import{r as q}from"./radius-DaoU83SK.js";import{s as N}from"./spacing-tE1IiUFl.js";import{c as r}from"./color-CiwAFuFb.js";import{b as g}from"./borderColor-C_RHITEf.js";import{t as l}from"./textColor-DLZeZODc.js";import{I as _}from"./IconCheck-Cgh-IEDk.js";import"./preload-helper-eJNa_G2e.js";const n=({variant:a="secondary",state:s="unchecked",disabled:t=!1,onChange:c,className:m="",...u})=>{const f=()=>{if(t)return;const i=s!=="checked";c==null||c(i)},h=()=>s==="checked"?e.jsx(_,{width:16,height:16,color:"currentColor"}):null;return e.jsx(E,{$variant:a,$state:s,$disabled:t,onClick:f,className:m,...u,children:h()})},E=W.div`
  width: 16px;
  height: 16px;
