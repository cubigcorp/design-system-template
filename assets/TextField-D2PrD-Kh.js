import{j as t}from"./jsx-runtime-lCEOkdJp.js";import{r as y}from"./iframe-C5u9g4Cs.js";import{d as s}from"./styled-components.browser.esm-BVHAQkXB.js";import{c as b}from"./color-CMFzNX_O.js";import{t as a,b as c}from"./borderColor-C1c8KEhD.js";import{t as p}from"./typography-D2BGv-2q.js";import{s as i}from"./spacing-tE1IiUFl.js";import{p as h,n as T}from"./negativeColor-vAhOVlFC.js";import{r as C}from"./radius-DaoU83SK.js";const k=({children:e,type:n="default",className:l="",...r})=>{const o=()=>{switch(n){case"required":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(O,{children:"*"})]});case"optional":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(A,{children:"(선택)"})]});default:return t.jsx("span",{children:e})}};return t.jsx(D,{$type:n,className:l,...r,children:o()})},D=s.label`
  ${p.body2}
  height: 20px;
  display: flex;
  align-items: center;
