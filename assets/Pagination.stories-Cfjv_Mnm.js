import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{R as B,r as _}from"./iframe-6QM99Qn2.js";import{c as f}from"./styled-components.browser.esm-CRgZ7Zfy.js";import{s as P}from"./spacing-tE1IiUFl.js";import{t as $}from"./typography-CHdGJV44.js";import{I as y}from"./IconButton-vbguOqMQ.js";import{S,b as L,a as C}from"./icon_more_outline_16-gw7-o1gB.js";import{T as A}from"./TextButton-DL5W1Yjd.js";import"./preload-helper-eJNa_G2e.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./lineHeight-aJXO3HIm.js";import"./borderColor-CzkI5wcR.js";import"./color-m2U5piog.js";import"./brandColor-Bb8P60S1.js";import"./negativeColor-fk0-w6JK.js";import"./radius-DaoU83SK.js";import"./textColor-G8dwupNW.js";import"./types-BtG8iaxF.js";const v=B.forwardRef(({currentPage:n,totalPages:i,onPageChange:m,variant:d="compact",maxVisiblePages:s,className:k,...I},N)=>{const b=()=>{n>1&&m(n-1)},z=()=>{n<i&&m(n+1)},R=t=>{m(t)},q=()=>{if(!s||i<=s)return Array.from({length:i},(g,O)=>O+1);const t=[],r=s-2,l=Math.floor(r/2);let h=!1,j=!1,o=1,c=i;n<=l+2?(o=1,c=s-1,j=c<i-1):n>=i-l-1?(o=i-s+2,c=i,h=o>2):(o=n-l,c=n+l,h=o>2,j=c<i-1),h&&(t.push(1),t.push("..."));for(let g=o;g<=c;g++)t.push(g);return j&&(t.push("..."),t.push(i)),t},E=()=>{const t=q();return e.jsxs(e.Fragment,{children:[e.jsx(y,{type:"solid",variant:"secondary",size:"small",onClick:b,disabled:n===1,icon:S}),e.jsx(G,{children:t.map((r,l)=>r==="..."?e.jsx(K,{children:e.jsx(L,{})},`ellipsis-${l}`):e.jsx(A,{variant:"secondary",size:"small",onClick:()=>R(r),children:r},r))}),e.jsx(y,{type:"solid",variant:"secondary",size:"small",onClick:z,disabled:n===i,icon:C})]})},F=()=>e.jsxs(e.Fragment,{children:[e.jsx(y,{type:"solid",variant:"secondary",size:"small",onClick:b,disabled:n===1,icon:S}),e.jsxs(J,{children:[n,"/",i]}),e.jsx(y,{type:"solid",variant:"secondary",size:"small",onClick:z,disabled:n===i,icon:C})]});return e.jsx(H,{ref:N,className:k,$variant:d,...I,children:d==="compact"?E():F()})});v.displayName="Pagination";const H=f.div`
  display: inline-flex;
  align-items: center;
