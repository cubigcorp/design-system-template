import{j as i}from"./jsx-runtime-D_zvdyIk.js";import{R as u}from"./iframe-skmiukBS.js";import{s as l,c as h}from"./styled-components.browser.esm-1f8qeTbm.js";import{b as p}from"./borderColor-CzkI5wcR.js";import{b as j}from"./brandColor-Bb8P60S1.js";import{c as e}from"./color-m2U5piog.js";import{f as m}from"./fontSize-BFAJJ5Eh.js";import{f as d}from"./fontWeight-CRwBdwgF.js";import{n as M,p as k}from"./negativeColor-fk0-w6JK.js";import{r as B}from"./radius-DaoU83SK.js";import{s as y}from"./spacing-tE1IiUFl.js";import{t as f}from"./textColor-G8dwupNW.js";import{S as z,r as D}from"./types-CWvy6brJ.js";const F=h.button`
  display: inline-flex;
  align-items: center;
...
`,N=({variant:t="primary",size:s="medium",radius:c="small",state:r="default",disabled:a=!1,loading:n=!1,leadingIcon:g,trailingIcon:v,label:x,children:$,onClick:w,className:b,lang:S})=>{const[V,o]=u.useState(r);u.useEffect(()=>{o(r)},[r]);const T=()=>{!a&&!n&&r==="default"&&o("hovered")},G=()=>{!a&&!n&&o(r)},C=()=>{!a&&!n&&r==="default"&&o("pressed")},q=()=>{!a&&!n&&r==="default"&&o("hovered")},E=()=>{!a&&!n&&r==="default"&&o("focused")},R=()=>{!a&&!n&&o(r)};return i.jsxs(F,{$variant:t,$size:s,$state:r!=="default"?r:V,$loading:n,$radius:c,disabled:a,onClick:w,className:b,lang:S,onMouseEnter:T,onMouseLeave:G,onMouseDown:C,onMouseUp:q,onFocus:E,onBlur:R,children:[i.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"4px",width:"100%",opacity:n?0:1,transition:"opacity 0.2s ease"},children:[g&&u.createElement(g),i.jsx(P,{children:$||x}),v&&u.createElement(v)]}),i.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",opacity:n?1:0,transition:"opacity 0.2s ease"},children:i.jsx(z,{})})]})};N.__docgenInfo={description:"",methods:[],displayName:"TextButton",props:{variant:{required:!1,tsType:{name:"union",raw:`| 'primary'
| 'secondary'
| 'tertiary'
| 'brand'
| 'positive'
