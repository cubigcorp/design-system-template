import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as q}from"./iframe-pNyzd6po.js";import{c as P}from"./styled-components.browser.esm-CdWSEUdl.js";import{r as z}from"./radius-DaoU83SK.js";import{s as F}from"./spacing-tE1IiUFl.js";import{c as s}from"./color-m2U5piog.js";import{b as f}from"./borderColor-CzkI5wcR.js";import{t as c}from"./textColor-G8dwupNW.js";import{I as O}from"./IconCheck-Cgh-IEDk.js";import"./preload-helper-eJNa_G2e.js";const r=({variant:n="secondary",state:l="unchecked",disabled:t=!1,onChange:i,className:u="",...x})=>{const h=()=>{if(t)return;const d=l!=="checked";i==null||i(d)},g=()=>l==="checked"?e.jsx(O,{width:16,height:16,color:"currentColor"}):null;return e.jsx(_,{$variant:n,$state:l,$disabled:t,onClick:h,className:u,...x,children:g()})},_=P.div`
  width: 16px;
  height: 16px;
