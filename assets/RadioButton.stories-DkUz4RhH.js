import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as T}from"./iframe-Diu4OQ1h.js";import{c as I}from"./styled-components.browser.esm-DZloA45Z.js";import{r as $}from"./radius-DaoU83SK.js";import{c as l}from"./color-BUCiRq0z.js";import{b as h}from"./borderColor-Bua6bgaN.js";import"./preload-helper-eJNa_G2e.js";const d=({state:t="unchecked",disabled:s=!1,onChange:n,className:u="",style:p,...m})=>{const b=()=>{if(s)return;const r=t!=="checked";n==null||n(r)};return e.jsx(w,{$state:t,$disabled:s,onClick:b,className:u,style:p,...m,children:t==="checked"&&e.jsx(W,{})})},w=I.div`
  width: 16px;
  height: 16px;
