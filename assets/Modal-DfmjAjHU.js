import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{t as f,d as l}from"./textColor-DPyvHAOL.js";import{c as s}from"./color-CiwAFuFb.js";import"./brandColor-OQPP65_V.js";import{p as Z,n as ee}from"./negativeColor-DPOOrHeE.js";import"./cautioniaryColor-DrCmYiBi.js";import{b as $}from"./borderColor-C_RHITEf.js";import{l as te}from"./layerColor-7aOJUZki.js";import{f as I}from"./fontFamily-CsG1KcIF.js";import{t as T,a as ge}from"./typography-BBThIZ7c.js";import{s as r}from"./spacing-tE1IiUFl.js";import{a as fe,b as ve,c as ae,d as re,e as he}from"./IconSearch-BQBSiVi4.js";import{I as ye}from"./IconCheck-CKtc9n1_.js";import{r as d,R as ne}from"./iframe-B5hpKK9d.js";import{r as oe}from"./index-ZohAnFDs.js";import{s as le}from"./shadow-DVq_1U2q.js";import{r as H}from"./radius-DaoU83SK.js";const z=({children:e,type:a="default",className:o="",lang:i,...c})=>{const p=i,m=()=>{switch(a){case"required":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(xe,{children:"*"})]});case"optional":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(we,{children:"(선택)"})]});default:return t.jsx("span",{children:e})}};return t.jsx(be,{$type:a,lang:p,className:o,...c,children:m()})},be=l.label`
...
`,Ve=ne.forwardRef((e,a)=>t.jsx(Me,{ref:a,...e})),Ne=l.button`
  width: 100%;
  border: 1px solid;
...
`,_e=ne.forwardRef((e,a)=>t.jsx(De,{ref:a,...e})),We=l.div`
  position: absolute;
  right: ${({size:e})=>e==="large"?r.gap["gap-2.5"]:r.gap["gap-2"]};
  top: 50%;
  transform: translateY(-50%);
