import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./iframe-CCQJzrSR.js";import{c as o}from"./styled-components.browser.esm-f0aNwSj6.js";import{I as ee,T as te,t as ne}from"./ToastSystem-VkZ-jdZH.js";import{c as r}from"./color-m2U5piog.js";import{b as _}from"./borderColor-CzkI5wcR.js";import{r as x}from"./radius-DaoU83SK.js";import{s as ie}from"./shadow-DVq_1U2q.js";import{s as a}from"./spacing-tE1IiUFl.js";import{a as G}from"./typography-CHdGJV44.js";import{t as re}from"./textColor-G8dwupNW.js";import{O as m,S as s}from"./SolidButton-C6kZsIko.js";import{T as M}from"./TextField-BFSgaErQ.js";import{D as ae}from"./Dropdown-DFOY-78A.js";import{T as se}from"./TextButton-CqeoKDxb.js";import"./preload-helper-eJNa_G2e.js";import"./IconCircleCheck-BBUUqRs3.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";import"./lineHeight-aJXO3HIm.js";import"./brandColor-Bb8P60S1.js";import"./negativeColor-fk0-w6JK.js";import"./types-CWRt5gxU.js";import"./Label-C3t-P4ow.js";import"./Input-CnXdipt5.js";import"./Description-BD1_-k_9.js";import"./ComboBox-fz0q8tvF.js";import"./index-D2lpCdh2.js";import"./index-CoLmYH2A.js";import"./IconArrowUp-Cts_pkXJ.js";import"./Menu-CrNfYB6b.js";import"./Cell-iXa5SZU0.js";import"./IconCheck-Cgh-IEDk.js";import"./MultiSelect-aY3y4r47.js";import"./Chip-DdfAbrPa.js";import"./icon_close_outline_16-BqBeQ3bW.js";import"./Selector-y0vdw1Tk.js";const J={light:{"bg-layer-basement":r.gray[50],"bg-layer-fill":r.gray[25],"bg-layer-floating":r.common[100],"bg-overlay":r.common.dimmer},dark:{"bg-layer-basement":r.gray[990],"bg-layer-default":r.gray[975],"bg-layer-fill":r.gray[950],"bg-layer-floating":r.gray[975]}},y=({size:n="medium",position:i="center",open:d=!1,onClose:l,title:p="제목",description:v,showCloseButton:h=!0,children:f,actions:C,className:K="",style:Q,...U})=>{const[O,$]=u.useState(!1),[X,w]=u.useState(!1);if(u.useEffect(()=>{if(d){w(!0);const c=setTimeout(()=>{$(!0)},10);return()=>clearTimeout(c)}else{$(!1);const c=setTimeout(()=>{w(!1)},200);return()=>clearTimeout(c)}},[d]),!X)return null;const Y=c=>{if(c.target.closest("[data-portal-menu]")){c.preventDefault(),c.stopPropagation();return}c.target===c.currentTarget&&(l==null||l())},Z=()=>{l==null||l()};return e.jsx(le,{$isVisible:O,$position:i,onMouseDown:Y,children:e.jsxs(oe,{$size:n,$isVisible:O,className:K,style:Q,...U,children:[e.jsxs(de,{children:[e.jsxs(ce,{children:[e.jsx(pe,{children:p}),v&&e.jsx(me,{children:v})]}),h&&e.jsx(ge,{onClick:Z,children:e.jsx(ee,{width:24,height:24,color:"currentColor"})})]}),e.jsx(ue,{children:f}),C&&e.jsx(ye,{children:C})]})})},le=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
