import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as t}from"./styled-components.browser.esm-DZloA45Z.js";import{c as p}from"./color-BUCiRq0z.js";import{r as x}from"./radius-DaoU83SK.js";import{s as i}from"./spacing-tE1IiUFl.js";import{t as o}from"./textColor-mWadn7SX.js";import{I as w}from"./IconCheck-Cgh-IEDk.js";import{t as m}from"./typography-CHdGJV44.js";const g=({disable:r=!1,active:s=!1,leadingContent:l,text:d,description:u,trailingIcon:c,onClick:n,className:f,lang:h,showCheckIcon:y=!0})=>{const a=()=>r?o.light["fg-neutral-disable"]:o.light["fg-neutral-primary"],v=()=>s&&!r&&y;return e.jsxs(q,{$disable:r,$active:s,"data-disable":r,onClick:r?void 0:b=>n==null?void 0:n(b),className:f,lang:h,children:[l&&e.jsx(T,{children:e.jsx(l,{color:a()})}),e.jsxs(j,{children:[d&&e.jsx(C,{children:d}),u&&e.jsx(k,{children:u})]}),v()&&e.jsx($,{children:c?e.jsx(c,{color:a()}):e.jsx(w,{width:16,height:16,color:a()})})]})},q=t.div`
  display: flex;
  align-items: center;
  gap: ${i.gap["gap-2"]};
