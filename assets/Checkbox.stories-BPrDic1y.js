import{j as e}from"./jsx-runtime-DU5MMG0J.js";import{r as V}from"./iframe-Bjjk8v-o.js";import{d as W}from"./styled-components.browser.esm-PYfggJBI.js";import{c}from"./color-CMFzNX_O.js";import{b as h,t as g}from"./borderColor-C1c8KEhD.js";import"./typography-BtvHU1C6.js";import{r as q}from"./radius-DaoU83SK.js";import{s as N}from"./spacing-tE1IiUFl.js";import{I as _}from"./IconCheck-BbzgY9Zj.js";import"./fontSize-BFAJJ5Eh.js";import"./fontWeight-CRwBdwgF.js";const n=({variant:r="secondary",state:a="unchecked",disabled:s=!1,onChange:t,className:m="",...y})=>{const u=()=>{if(s)return;const l=a!=="checked";t==null||t(l)},f=()=>a==="checked"?e.jsx(_,{width:16,height:16,color:"currentColor"}):null;return e.jsx(E,{$variant:r,$state:a,$disabled:s,onClick:u,className:m,...y,children:f()})},E=W.div`
  width: 16px;
  height: 16px;
  ...
  ${({$variant:r,$state:a,$disabled:s})=>s?`
...
\r
      ...
      alignItems: "center"
        ...
        alignItems: "center"
          ...
          <Checkbox variant="primary" state="checked" disabled={true} />\r
        </div>\r
        <div style={{
        display: "flex",
        flexDirection: "column",
        ...
        alignItems: "center"
          ...
          <Checkbox variant="primary" state="unchecked" disabled={true} />\r
        </div>\r
        <div style={{
        display: "flex",
        flexDirection: "column",
...
}`,...(A=(w=x.parameters)==null?void 0:w.docs)==null?void 0:A.source}}};const Z=["Default","AllStates","AllVariants","AllCombinations","Interactive"];export{p as AllCombinations,o as AllStates,d as AllVariants,i as Default,x as Interactive,Z as __namedExportsOrder,Y as default};
