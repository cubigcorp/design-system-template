import{j as i}from"./jsx-runtime-BTbXV3wk.js";import{l,d as y}from"./styled-components.browser.esm-DOMakniN.js";import{c as e}from"./color-DlZ4f652.js";import{r as M}from"./radius-DaoU83SK.js";import{f as d}from"./fontWeight-CRwBdwgF.js";import{f as p}from"./fontSize-BFAJJ5Eh.js";import{b as u,t as v}from"./borderColor-7dRAAa5F.js";import{s as w}from"./spacing-tE1IiUFl.js";import{S as B}from"./Spinner-BN6ngqTz.js";import{R as c}from"./iframe-D5_AN2oD.js";import{b as P}from"./brandColor-9nHZhGOS.js";import{n as g,p as h}from"./negativeColor-DFTQtxpe.js";const F=y.button.withConfig({shouldForwardProp:r=>!["loading","state"].includes(r)})`
  display: inline-flex;
  align-items: center;
...
`,L=y.span`
  padding: 0 ${w.gap["gap-0.5"]};
`,U=({variant:r="primary",size:a="medium",state:t="default",disabled:s=!1,loading:n=!1,leadingIcon:m,trailingIcon:f,label:$,children:x,onClick:b,className:S})=>{const[V,o]=c.useState(t);c.useEffect(()=>{o(t)},[t]);const G=()=>{!s&&!n&&o("hovered")},T=()=>{!s&&!n&&o(t)},E=()=>{!s&&!n&&o("pressed")},q=()=>{!s&&!n&&o("hovered")},C=()=>{!s&&!n&&o("focused")},R=()=>{!s&&!n&&o(t)};return i.jsx(I,{variant:r,size:a,state:V,disabled:s,loading:n,onClick:b,className:S,onMouseEnter:G,onMouseLeave:T,onMouseDown:E,onMouseUp:q,onFocus:C,onBlur:R,children:n?i.jsx(B,{}):i.jsxs(i.Fragment,{children:[m&&c.createElement(m),i.jsx(L,{children:x||$}),f&&c.createElement(f)]})})};U.__docgenInfo={description:"",methods:[],displayName:"TextButton",props:{variant:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "brand"
| "positive"
