import{j as t}from"./jsx-runtime-BJTMVYLA.js";import{r as y}from"./iframe-C2yBEhu8.js";import{d as s}from"./styled-components.browser.esm-BTp3bCWR.js";import{c as b}from"./color-CMFzNX_O.js";import{t as a,b as c}from"./borderColor-C1c8KEhD.js";import{t as d}from"./typography-D2BGv-2q.js";import{s as i}from"./spacing-tE1IiUFl.js";import{p as h,n as T}from"./negativeColor-vAhOVlFC.js";import{r as C}from"./radius-DaoU83SK.js";const k=({children:e,type:n="default",className:l="",...r})=>{const o=()=>{switch(n){case"required":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(O,{children:"*"})]});case"optional":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(A,{children:"(선택)"})]});default:return t.jsx("span",{children:e})}};return t.jsx(D,{$type:n,className:l,...r,children:o()})},D=s.label`
  ${d.body2}
  height: 20px;
  display: flex;
  align-items: center;
...
`,J=s.input`
  ...
  ${({$status:e,$disabled:n,$active:l,$focused:r})=>n?`
      ...
      `:e==="normal"?l&&r?`
        ...
        `:!l&&r?`
          background-color: transparent;
          color: ${a.light["fg-neutral-assistive"]};
          border-color: ${c.light["color-border-focused"]};
        `:`
          background-color: transparent;
          color: ${a.light["fg-neutral-assistive"]};
