import{j as t}from"./jsx-runtime-xCA2v9vi.js";import{r as c}from"./iframe-OZy89DUD.js";import{d as s,l as F,m as ae}from"./styled-components.browser.esm-DOVniiux.js";import{c as u}from"./color-DlZ4f652.js";import{t as i}from"./textColor-DVi7834n.js";import{p as D,n as G}from"./negativeColor-DFTQtxpe.js";import{b as x}from"./borderColor-BrY1a26q.js";import{f as M}from"./fontFamily-CsG1KcIF.js";import{t as E}from"./typography-5QY5Grkh.js";import{r as O}from"./radius-DaoU83SK.js";import{s as n}from"./spacing-tE1IiUFl.js";import{a as X,b as U,c as ge,d as he,I as ve,e as re,f as ne,g as ye,h as be,i as xe}from"./IconClose-CIdcCMJS.js";import{s as le}from"./shadow-DVq_1U2q.js";const B=({children:e,type:a="default",className:r="",lang:l,...o})=>{const d=l,p=()=>{switch(a){case"required":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx($e,{children:"*"})]});case"optional":return t.jsxs(t.Fragment,{children:[t.jsx("span",{children:e}),t.jsx(Te,{children:"(선택)"})]});default:return t.jsx("span",{children:e})}};return t.jsx(we,{$type:a,lang:d,className:r,...o,children:p()})},we=s.label`
...
`;P.displayName="Description";P.__docgenInfo={description:"",methods:[],displayName:"Description",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},status:{required:!1,tsType:{name:"union",raw:'"default" | "negative" | "positive"',elements:[{name:"literal",value:'"default"'},{name:"literal",value:'"negative"'},{name:"literal",value:'"positive"'}]},description:"",defaultValue:{value:'"default"',computed:!1}},leadingIcon:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'""',computed:!1}},lang:{required:!1,tsType:{name:"union",raw:'"ko" | "en"',elements:[{name:"literal",value:'"ko"'},{name:"literal",value:'"en"'}]},description:""}}};const K=c.forwardRef(({size:e="medium",status:a="default",disabled:r=!1,active:l=!1,focused:o=!1,placeholder:d,value:p,type:g="text",onChange:$,onFocus:f,onBlur:q,className:C="",lang:R,...S},w)=>{const[b,L]=c.useState(!1),[T,j]=c.useState(o);c.useEffect(()=>{j(o)},[o]);const y=v=>{j(!0),f==null||f(v)},k=v=>{j(!1),q==null||q(v)},h=g==="password"&&p&&p.trim()!==""?{icon:b?"visibility-on":"visibility-off",color:i.light["fg-neutral-primary"]}:r?a==="positive"?{icon:"circlecheck",color:D.light["fg-positive-primary"]}:null:a==="negative"?l?null:{icon:"error",color:G.light["fg-negative-primary"]}:a==="positive"?l?null:{icon:"circlecheck",color:D.light["fg-positive-primary"]}:null,H=R;return t.jsxs(Ee,{children:[t.jsx(je,{ref:w,type:g==="password"?b?"text":"password":g,value:p,onChange:$,onFocus:y,onBlur:k,placeholder:d,disabled:r,className:C,$size:e,$status:a,$disabled:r,$active:l,$focused:T,lang:H,...Object.fromEntries(Object.entries(S).filter(([v])=>!["active","focused","status","size"].includes(v)))}),h&&t.jsxs(Re,{$size:e,$color:h.color,onMouseDown:v=>{v.preventDefault(),(h.icon==="visibility-on"||h.icon==="visibility-off")&&L(!b)},type:"button",children:[h.icon==="error"&&t.jsx(U,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:h.color}),h.icon==="circlecheck"&&t.jsx(X,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:h.color}),h.icon==="visibility-on"&&t.jsx(ge,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:h.color}),h.icon==="visibility-off"&&t.jsx(he,{width:e==="small"?16:e==="large"?24:20,height:e==="small"?16:e==="large"?24:20,color:h.color})]})]})}),Ee=s.div`
  position: relative;
  ...
  ${({$status:e,$disabled:a,$active:r,$focused:l})=>a?`
      ...
      `:e==="default"?r&&l?`
        ...
        `:`
          background-color: transparent;
          color: ${i.light["fg-neutral-primary"]};
          border-color: ${x.light["color-border-negative"]};
        `:e==="positive"?r&&l?`
          background-color: transparent;
          color: ${i.light["fg-neutral-primary"]};
          border-color: ${x.light["color-border-focused"]};
...
`;A.displayName="Menu";A.__docgenInfo={description:"",methods:[],displayName:"Menu",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const W=({disable:e=!1,active:a=!1,leadingIcon:r,text:l,description:o,trailingIcon:d,onClick:p,className:g,lang:$})=>{const f=()=>e?i.light["fg-neutral-disable"]:i.light["fg-neutral-primary"],q=()=>a&&!e;return t.jsxs(Le,{disable:e,active:a,"data-disable":e,onClick:e?void 0:p,className:g,lang:$,children:[r&&t.jsx(Se,{children:t.jsx(r,{width:16,height:16,color:f()})}),t.jsxs(Me,{children:[l&&t.jsx(He,{children:l}),o&&t.jsx(Fe,{children:o})]}),q()&&t.jsx(Ne,{children:d?t.jsx(d,{width:16,height:16,color:f()}):t.jsx(ve,{width:16,height:16,color:f()})})]})},Le=s.div`
  display: flex;
  align-items: center;
  gap: ${n.gap["gap-1"]};
...
`,Xe=s.div`
  ...
  cursor: pointer;
  pointer-events: auto;
`;Q.displayName="ComboBox";Q.__docgenInfo={description:"",methods:[],displayName:"ComboBox",props:{size:{required:!1,tsType:{name:"union",raw:'"small" | "medium" | "large"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},active:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},focused:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},placeholder:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"입력하거나 선택해주세요."',computed:!1}},value:{required:!1,tsType:{name:"string"},description:""},options:{required:!1,tsType:{name:"Array",elements:[{name:"ComboBoxOption"}],raw:"ComboBoxOption[]"},description:"",defaultValue:{value:"[]",computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},onFocus:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.FocusEvent<HTMLInputElement>) => void",signature:{arguments:[{type:{name:"ReactFocusEvent",raw:"React.FocusEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}]},name:"event"}],return:{name:"void"}}},description:""},onBlur:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.FocusEvent<HTMLInputElement>) => void",signature:{arguments:[{type:{name:"ReactFocusEvent",raw:"React.FocusEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}]},name:"event"}],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'""',computed:!1}},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""},lang:{required:!1,tsType:{name:"union",raw:'"ko" | "en"',elements:[{name:"literal",value:'"ko"'},{name:"literal",value:'"en"'}]},description:"",defaultValue:{value:'"ko"',computed:!1}}}};const se=({type:e="selector",size:a="medium",disabled:r=!1,active:l=!1,focused:o=!1,placeholder:d="선택해주세요.",value:p,options:g=[],label:$,labelType:f="default",description:q,descriptionLeadingIcon:C=!1,status:R="default",onChange:S,onFocus:w,onBlur:b,className:L="",style:T,lang:j,...y})=>{const k=j;return t.jsxs(Ue,{className:`dropdown-container ${L}`,style:T,...Object.fromEntries(Object.entries(y).filter(([I])=>!["active","focused","size","disabled"].includes(I))),children:[$&&t.jsx(B,{type:f,lang:k,children:$}),e==="combobox"?t.jsx(Q,{size:a,disabled:r,active:l,focused:o,placeholder:d,value:p,options:g,onChange:S,onFocus:w,onBlur:b,lang:k}):t.jsx(J,{size:a,disabled:r,active:l,focused:o,placeholder:d,value:p,options:g,onChange:S,onFocus:w,onBlur:b,lang:k}),q&&t.jsx(P,{status:R,leadingIcon:C,lang:k,children:q})]})},Ue=s.div`
  position: relative;
  display: flex;
  flex-direction: column;
  gap: ${n.gap["gap-1"]};
...
`;se.displayName="Dropdown";se.__docgenInfo={description:"",methods:[],displayName:"Dropdown",props:{type:{required:!1,tsType:{name:"union",raw:'"selector" | "combobox"',elements:[{name:"literal",value:'"selector"'},{name:"literal",value:'"combobox"'}]},description:"",defaultValue:{value:'"selector"',computed:!1}},size:{required:!1,tsType:{name:"union",raw:'"small" | "medium" | "large"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},active:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},focused:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},placeholder:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"선택해주세요."',computed:!1}},value:{required:!1,tsType:{name:"string"},description:""},options:{required:!1,tsType:{name:"Array",elements:[{name:"DropdownOption"}],raw:"DropdownOption[]"},description:"",defaultValue:{value:"[]",computed:!1}},label:{required:!1,tsType:{name:"string"},description:""},labelType:{required:!1,tsType:{name:"union",raw:'"default" | "required" | "optional"',elements:[{name:"literal",value:'"default"'},{name:"literal",value:'"required"'},{name:"literal",value:'"optional"'}]},description:"",defaultValue:{value:'"default"',computed:!1}},description:{required:!1,tsType:{name:"string"},description:""},descriptionLeadingIcon:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},status:{required:!1,tsType:{name:"union",raw:'"default" | "negative" | "positive"',elements:[{name:"literal",value:'"default"'},{name:"literal",value:'"negative"'},{name:"literal",value:'"positive"'}]},description:"",defaultValue:{value:'"default"',computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},onFocus:{required:!1,tsType:{name:"signature",type:"function",raw:`(
  ...
  event: React.FocusEvent<HTMLButtonElement | HTMLInputElement>
) => void`,signature:{arguments:[{type:{name:"ReactFocusEvent",raw:"React.FocusEvent<HTMLButtonElement | HTMLInputElement>",elements:[{name:"union",raw:"HTMLButtonElement | HTMLInputElement",elements:[{name:"HTMLButtonElement"},{name:"HTMLInputElement"}]}]},name:"event"}],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'""',computed:!1}},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""},lang:{required:!1,tsType:{name:"union",raw:'"ko" | "en"',elements:[{name:"literal",value:'"ko"'},{name:"literal",value:'"en"'}]},description:""}}};const Ke=ae`
  from {
    opacity: 0;
...
`,ue=({children:e,description:a,variant:r="default",placement:l="bottom-right",offset:o=40,onClose:d,showLeadingIcon:p=!0,showTrailingIcon:g=!0,showDivider:$=!1,className:f="",autoClose:q=!1,autoCloseDelay:C=3e3,index:R=0,disablePositioning:S=!1,lang:w,...b})=>{const[L,T]=c.useState(!1),[j,y]=c.useState(!1),k=typeof R=="number"?R:_;c.useEffect(()=>(_+=1,()=>{_=Math.max(0,_-1)}),[]),c.useEffect(()=>{if(T(!0),q){const v=setTimeout(()=>{y(!0)},C);return()=>clearTimeout(v)}},[q,C]);const I=()=>{y(!0),setTimeout(()=>{d==null||d()},500)},h=()=>{if(!p)return null;switch(r){case"positive":return t.jsx(X,{width:20,height:20,color:"currentColor"});case"negative":return t.jsx(U,{width:20,height:20,color:"currentColor"});case"cautionary":return t.jsx(be,{width:20,height:20,color:"currentColor"});case"default":default:return t.jsx(ye,{width:20,height:20,color:"currentColor"})}},H=()=>g?t.jsx(rt,{onClick:I,children:t.jsx(xe,{width:16,height:16,color:"currentColor"})}):null;return t.jsxs(ze,{$variant:r,$placement:l,$offset:o,$isVisible:L,$isExiting:j,$index:k,$disablePositioning:S,className:f,...Object.fromEntries(Object.entries(b).filter(([v])=>!["variant","placement","offset"].includes(v))),children:[p&&t.jsx(et,{$variant:r,children:t.jsx(te,{children:h()})}),t.jsxs(tt,{lang:w,children:[t.jsx("div",{children:e}),a&&t.jsx("div",{children:a})]}),$&&t.jsx(at,{$variant:r}),g&&t.jsx(te,{children:H()})]})},Qe=16,Ze=80;let _=0;const ze=s.div`
  display: flex;
  align-items: center;
  ...
  ${({$disablePositioning:e,$index:a=0,$placement:r,$offset:l})=>!e&&F`
      ...
      /* placement에 따른 위치 설정 */
      ${()=>{const o=l+a*(Ze+Qe);switch(r){case"top-left":return F`
              top: ${o}px;
              left: ${l}px;
  ...
  ${({$isVisible:e,$isExiting:a,$placement:r})=>a?F`
        animation: ${Je} 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)
          forwards;
      `:e?F`
        animation: ${Ke} 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)
          forwards;
      `:F`
        opacity: 0;
