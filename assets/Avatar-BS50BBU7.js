import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{R as c}from"./iframe-D4fn7yV1.js";import{l as r,d as f}from"./styled-components.browser.esm-kr1dGAPk.js";import{b as h}from"./borderColor-C_RHITEf.js";import{c as i}from"./color-CiwAFuFb.js";import{r as a}from"./radius-DaoU83SK.js";import{t as g}from"./textColor-DLZeZODc.js";import{t as x}from"./typography-CHdGJV44.js";const C=f.div`
  display: flex;
  align-items: center;
  ...
  ${({$type:e,$size:t})=>e==="initial"?r`
        background-color: ${i.gray[900]};
        color: ${i.common[100]};
        ${x(void 0,t==="x-small"?"caption2":t==="small"?"body3":t==="medium"?"heading1":"heading3","medium")}
      `:e==="custom"?r`
      ...
      color: ${g.light["fg-neutral-assistive"]};
      svg {
        ${t==="x-small"&&r`
          width: 16px;
          height: 16px;
